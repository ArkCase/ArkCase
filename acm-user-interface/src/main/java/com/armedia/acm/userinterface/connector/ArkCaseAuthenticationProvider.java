...
public class ArkCaseAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException
    {
        ...
        try
        {
            connectorSession = getArkCaseAuthenticator().authenticate("http://192.168.178.51:8080/acm", credentials, connectorSession);
            String ticket = (String) connectorSession.getParameter(UserInterfaceConstants.ACM_TICKET);
