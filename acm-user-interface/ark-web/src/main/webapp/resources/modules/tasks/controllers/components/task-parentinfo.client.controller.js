...
angular.module('tasks').controller('Tasks.ParentInfoController', ['$scope', '$stateParams', 'StoreService', 'UtilService', 'ValidationService', 'HelperService', 'LookupService', 'TasksService', 'TasksModelsService',
    function ($scope, $stateParams, Store, Util, Validator, Helper, LookupService, TasksService, TasksModelsService) {
        ...
        /**
         * Persists the updated taskfile metadata to the ArkTask database
         */
        function saveTask() {
