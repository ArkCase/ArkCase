 ...
 * @description
 *
 * {@link https://github.com/Armedia/ACM3/blob/develop/acm-user-interface/ark-web/src/main/webapp/resources/modules/admin/services/branding.logo.client.service.js modules/admin/services/branding.logo.client.service.js}
 *
    ...
    function (http, Upload) {
        ...
        function uploadLogo(files, formNames) {
            return Upload.upload({
                url: 'proxy/arkcase/api/latest/plugin/admin/branding/customlogos',
                method: 'POST',
