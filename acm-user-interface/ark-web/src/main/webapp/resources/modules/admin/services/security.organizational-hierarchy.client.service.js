 ...
 * @description
 *
 * {@link https://github.com/Armedia/ACM3/blob/develop/acm-user-interface/ark-web/src/main/webapp/resources/modules/admin/services/security.organizational-hierarchy.client.service.js modules/admin/services/security.organizational-hierarchy.client.service.js}
 *
...
angular.module('admin').service('Admin.OrganizationalHierarchyService', function ($http) {
     ...
     */
    function getGroups(currentPage, pageSize) {
        return $http({
            method: 'GET',
    ...
    function getGroupsTopLevel(currentPage, pageSize) {
        ...
        return $http({
            method: 'GET',
            url: 'proxy/arkcase/api/latest/users/group/get/toplevel?n=' + n + '&start=' + start + '&s=create_date_tdt desc'
        });
    }
    ...
    function getUsersForGroup(group) {
        return $http({
            method: 'GET',
            url: 'proxy/arkcase/api/latest/users/by-group/' + group
        });
    }
    ...
    function addAdHocGroup(group, parent) {
        var url = 'proxy/arkcase/api/latest/users/group/save';
        if (parent)
    ...
    function saveMembers(group, members) {
        ...
        var url = 'proxy/arkcase/api/latest/users/group/' + group.object_id_s + '/members/save';
        return $http({
            method: 'POST',
            url: url,
    ...
    function removeMembers(group, members) {
        ...
        var url = 'proxy/arkcase/api/latest/users/group/' + group.object_id_s + '/members/remove';
        return $http({
            method: 'POST',
            url: url,
    ...
    function removeGroup(group) {
        var url = 'proxy/arkcase/api/latest/users/group/' + group.object_id_s + '/remove';
        return $http({
            method: 'DELETE',
            url: url,
            headers: {
    ...
    function setSupervisor(group, member) {
        ...
        var url = 'proxy/arkcase/api/latest/users/group/' + group.object_id_s + '/supervisor/save/false';
        return $http({
            method: 'POST',
            url: url,
