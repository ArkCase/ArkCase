...
angular.module('admin').factory('Admin.LabelsConfigService', ['$resource',
    function ($resource) {
        return $resource('proxy/arkcase/api/latest/plugin/admin/labelmanagement', {}, {
            ...
            retrieveNamespaces: {
                method: "GET",
                url: "proxy/arkcase/api/latest/plugin/admin/labelmanagement/namespaces",
                cache: false,
                isArray: true
            },
            ...
            retrieveLanguages: {
                method: "GET",
                url: "proxy/arkcase/api/latest/plugin/admin/labelmanagement/languages",
                cache: false,
                isArray: true
            },
            ...
            retrieveResource: {
                method: "GET",
                url: "proxy/arkcase/api/latest/plugin/admin/labelmanagement/admin-resource?lang=:lang&ns=:ns",
                cache: false,
                isArray: true
            },
            ...
            resetResource: {
                method: "POST",
                url: "proxy/arkcase/api/latest/plugin/admin/labelmanagement/admin-resource/reset",
                cache: false
            },
