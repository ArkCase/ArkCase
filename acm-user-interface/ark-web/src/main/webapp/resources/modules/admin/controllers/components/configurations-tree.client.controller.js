...
angular.module('admin').controller('Admin.ConfigurationsTreeController',
    ['$scope', '$state', '$stateParams', '$log', 'ConfigService', '$q', '$parse',
        function ($scope, $state, $stateParams, $log, ConfigService, $q, $parse) {
            function setTitle(treeNode) {
                ...
                treeNode["title"] = $parse("'" + treeNode.title + "' | translate")();
            };
