...
angular.module('services').factory('Object.TimeService', ['$resource', '$q', 'StoreService', 'UtilService', 'Object.ListService', 'Authentication'
    , function ($resource, $q, Store, Util, ObjectListService, Authentication) {
        var Service = $resource('proxy/arkcase/api/latest/service', {}, {
            ...
            _queryTimesheets: {
                method: 'GET',
                //url: 'proxy/arkcase/api/latest/service/timesheet/objectId/:objectId/objectType/:objectType?start=:start&n=:n&s=:sort',
                url: 'proxy/arkcase/api/latest/service/timesheet/objectId/:objectId/objectType/:objectType',
                cache: false,
                isArray: true
            }
        });
