 ...
 * @description
 *
 * {@link https://github.com/Armedia/ACM3/blob/develop/acm-user-interface/ark-web/src/main/webapp/resources/services/objects/object-correspondence.client.service.js services/objects/object-correspondence.client.service.js}
    ...
    function ($resource, Store, Util) {
        var Service = $resource('proxy/arkcase/api/latest/plugin', {}, {
            ...
            _queryCorrespondences: {
                method: 'GET',
                url: 'proxy/arkcase/api/latest/service/ecm/bycategory/:parentType/:parentId?category=Correspondence&start=:start&n=:n&s=:sort',
                cache: false
            }
