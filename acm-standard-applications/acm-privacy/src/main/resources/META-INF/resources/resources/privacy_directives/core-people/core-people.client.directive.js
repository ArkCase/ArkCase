...
angular.module('directives').directive(
        ...
        [
                ...
                "Authentication",
                function($stateParams, $q, $translate, $modal, Util, ObjectPersonService, ObjectLookupService, HelperUiGridService, HelperObjectBrowserService, Authentication) {
                    return {
                        restrict: 'E',
                        scope: {
                            peopleInit: '='
                        ...
                        link: function(scope, element, attrs) {
                            ...
                            var promisePersonTypes = ObjectLookupService.getPersonTypes().then(function(personTypes) {
                                var options = [];
                            ...
                            var promiseContactMethodTypes = ObjectLookupService.getContactMethodTypes().then(function(contactMethodTypes) {
                            ...
                            scope.deleteRow = function(rowEntity) {
                                ...
                                if (0 < id) { //do not need to save for deleting a new row
                                    ObjectPersonService.deletePersonAssociation(id).then(function(personAssociationDeleted) {
                                        refresh();
                            ...
                            var showModalPeople = function(person, isEdit) {
                                ...
                                modalInstance.result.then(function(data) {
                                    ...
                                    if (data.isEdit) {
                                        ...
                                        ObjectPersonService.addPersonAssociation(scope.personAssociation).then(function(personAssociation) {
                                            refresh();
                            ...
                            var showModalContactMethods = function(contact, isEdit) {
                                ...
                                modalInstance.result.then(function(data) {
                                    ...
                                    if (!data.isEdit)
                                        ...
                                        contactMethod = _.find(personAssociation.person.contactMethods, {
                                            id: data.contact.id
                                        });
                                    }
                            ...
                            var showModalOrganizations = function(organization, isEdit) {
                                ...
                                modalInstance.result.then(function(data) {
                                    ...
                                    if (!data.isEdit) {
                                        ...
                                        organization = _.find(personAssociation.person.organizations, {
                            ...
                            var showModalAddresses = function(address, isEdit) {
                                ...
                                modalInstance.result.then(function(data) {
                                    ...
                                    if (!data.isEdit)
                                        ...
                                        address = _.find(personAssociation.person.addresses, {
                                            id: data.address.id
                                        });
                                    }
                            ...
                            var showModalAliases = function(alias, isEdit) {
                                ...
                                modalInstance.result.then(function(data) {
                                    ...
                                    if (!data.isEdit)
                                        ...
                                        alias = _.find(personAssociation.person.personAliases, {
                                            id: data.alias.id
                                        });
                                    }
                            ...
                            var saveObjectInfoAndRefresh = function(pa) {
                                ...
                                ObjectPersonService.addPersonAssociation(personAssociation).then(function(personAssociation) {
                                    refresh();
                                    scope.personAssociation = personAssociation;
                                    var idxPa = _.findIndex(scope.objectInfo.personAssociations, function(pa) {
