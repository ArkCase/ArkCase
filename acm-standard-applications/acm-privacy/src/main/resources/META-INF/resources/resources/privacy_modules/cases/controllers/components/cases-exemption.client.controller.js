...
angular.module('cases').controller('Cases.ExemptionController',
    ['$scope', '$stateParams', '$q', 'Case.InfoService', 'Helper.UiGridService', 'Helper.ObjectBrowserService', 'Case.ExemptionService', 'ConfigService', '$modal', 'Object.LookupService', 'Profile.UserInfoService', 'UtilService', 'MessageService',
        function ($scope, $stateParams, $q, CaseInfoService, HelperUiGridService, HelperObjectBrowserService, CaseExemptionService, ConfigService, $modal, ObjectLookupService, UserInfoService, Util, MessageService) {
