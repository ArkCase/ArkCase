...
public class ApproveBusinessProcessIT
{
    private final String processName = "foia-extension-approve-process";
    @Autowired
    ...
    public void setUp() throws Exception
    {
        ...
        repo.createDeployment()
                .addClasspathResource("activiti/foia-extension-approve-process_v5.bpmn20.xml")
                .deploy();
    }
