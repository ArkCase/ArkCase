...
public class DeclareRequestFilesAsRecordsJobDescriptor extends AcmJobDescriptor
{
    ...
    {
        return "declareRequestFilesAsRecordsJob";
    }

    @Override
    public void executeJob(JobExecutionContext context)
    {
        declareRequestAsRecordService.executeJob();
    }
