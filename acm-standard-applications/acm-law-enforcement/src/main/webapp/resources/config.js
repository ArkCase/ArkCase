...
var ApplicationConfiguration = (function() {
    ...
    var applicationModuleVendorDependencies = [ 'cgNotify', 'ngResource', 'ngCookies', 'ngAnimate', 'ngTouch', 'ngSanitize', 'ngAnimate',
            ...
            //'ui.utils',
            'ui.grid', 'ui.grid.pagination', 'ui.grid.resizeColumns', 'ui.grid.autoResize', 'ui.grid.selection', 'ui.grid.expandable',
            'ui.grid.edit', 'ui.grid.exporter', 'ui.grid.moveColumns', 'xeditable', 'summernote', 'ngBootbox', 'ngHandsontable',
            'ngTagsInput', 'ui.ace', 'cfp.hotkeys', 'angular-google-analytics', "com.2fdevs.videogular",
            "com.2fdevs.videogular.plugins.controls", "com.2fdevs.videogular.plugins.overlayplay", "com.2fdevs.videogular.plugins.poster",
            "com.2fdevs.videogular.plugins.buffering", "tmh.dynamicLocale", "ab-base64" ];
