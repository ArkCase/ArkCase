 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/common/util.client.service.js services/common/util.client.service.js}
 *
                            ...
                            var Util = {
                                ...
                                serviceCall : function(arg) {
                                    ...
                                    callbacks.onError = function(errorData) {
                                        ...
                                        if (rc) {
                                            $log.error("service call error:[" + Util.goodMapValue(rc, "status") + ", "
                                                    + Util.goodMapValue(rc, "statusText") + "]" + Util.goodMapValue(rc, "data"));
                                        } else {
                                ...
                                dateToIsoString : function(d) {
                                    ...
                                    console
                                            .log("Compatibility warning: UtilService.dateToIsoString() phase out. Please use Util.DateService.dateToIso()");
