                        ...
                        if (actions.length > 0) {
                            ...
                            _.forEach(actions, function(action) {
                                ...
                                if (isEnabled && action.objectProperties) {
                                    _.forEach(action.objectProperties,
                                            function(value, key) {
                                                isEnabled = isEnabled
                                                        && ((_.indexOf(value, _.get(objectProperties, key)) != -1) || (_.get(
                                ...
                                if (isEnabled && action.userIsParticipantTypeAny && action.userIsParticipantTypeAny.length > 0) {
                                    ...
                                    _.forEach(action.userIsParticipantTypeAny, function(value) {
                                        ...
                                        if (participant) {
                                            isUserParticipant = (participant == userProfile.userId)
                                                    || (_.includes(userProfile.authorities, participant));
