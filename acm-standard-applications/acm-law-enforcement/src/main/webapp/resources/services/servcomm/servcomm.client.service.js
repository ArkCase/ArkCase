    ...
    , function ($rootScope, $timeout, Store, Util) {
        var Service = {
            ...
            , request: function (scope, channel, topic, data) {
                scope.$emit("rootScope:servcomm-request", {channel: channel, topic: topic, data: data});
            }
            ...
            , response: function (channel, topic, data) {
                $rootScope.$broadcast("rootScope:servcomm-response", {channel: channel, topic: topic, data: data});
            }
