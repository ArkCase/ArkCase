 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/object/object-cost.client.service.js services/object/object-cost.client.service.js}

 * Object.CostService includes functions for object relate to cost.
 */
angular.module('services').factory('Object.CostService', [ '$resource', '$q', 'Acm.StoreService', 'UtilService', 'Object.ListService', 'Authentication', function($resource, $q, Store, Util, ObjectListService, Authentication) {
    var Service = $resource('api/latest/service', {}, {
        ...
        _queryCostsheets: {
            method: 'GET',
            //url: 'api/latest/service/costsheet/objectId/:objectId/objectType/:objectType?start=:start&n=:n&s=:sort',
            url: 'api/latest/service/costsheet/objectId/:objectId/objectType/:objectType',
            cache: false,
            isArray: true
        }
    });
