 ...
 */
angular.module('services').factory('Object.SubscriptionService',
        [ '$resource', '$q', 'Acm.StoreService', 'UtilService', 'Authentication', function($resource, $q, Store, Util, Authentication) {
