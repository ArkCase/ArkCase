 ...
 * @description
 *
 * {@link /acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/object/object-subscription.client.service.js services/object/object-subscription.client.service.js}

 * Object.SubscriptionService includes methods for managing subscriptions
 */
angular.module('services').factory('Object.SubscriptionService', [ '$resource', '$q', 'Acm.StoreService', 'UtilService', 'Authentication', function($resource, $q, Store, Util, Authentication) {
    ...
    Service.getListOfSubscriptionsByUser = function() {
        ...
        return Authentication.queryUserInfo().then(function(userInfo) {
