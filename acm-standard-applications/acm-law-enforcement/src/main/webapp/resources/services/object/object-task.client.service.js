 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/object/object-task.client.service.js services/object/object-task.client.service.js}

 * Object.TaskService includes functions for object relate to task.
 */
angular.module('services').factory('Object.TaskService', [ '$resource', '$q', 'Acm.StoreService', 'UtilService', 'SearchService', 'Authentication', function($resource, $q, Store, Util, SearchService, Authentication) {
    ...
    Service.queryCurrentUserTasks = function() {
        ...
        Authentication.queryUserInfo().then(function(userInfo) {
            Service.queryMyTasks(userInfo.userId).then(function(myTasks) {
                dfd.resolve(myTasks);
                return myTasks;
            }, function(error) {
                dfd.reject(error);
