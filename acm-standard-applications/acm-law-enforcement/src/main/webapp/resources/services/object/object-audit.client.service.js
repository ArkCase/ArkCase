 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/object/object-audit.client.service.js services/object/object-audit.client.service.js}

 * Object.AuditService includes group of audit related REST calls.
 */
angular.module('services').factory('Object.AuditService', [ '$resource', 'Acm.StoreService', 'UtilService', function($resource, Store, Util) {
    var Service = $resource('api/latest/plugin', {}, {
        ...
        _queryAudit: {
            method: 'GET',
            url: 'api/latest/plugin/audit/:objectType/:objectId?start=:start&n=:n&s=:sort',
            cache: false
        }
    });
