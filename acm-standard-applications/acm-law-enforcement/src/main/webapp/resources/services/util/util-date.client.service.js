                ...
                function($translate, Util) {
                    var Service = {
                        ...
                        convertToCurrentTime : function(date) {
                            var now = new Date();
                            var convertedTime = new Date(date.getFullYear(), date.getMonth(), date.getDate(), now.getHours(), now
                                    .getMinutes(), now.getSeconds(), now.getMilliseconds());
                        ...
                        setSameTime : function(firstDate, secondDate) {
                            firstDate = new Date(firstDate.getFullYear(), firstDate.getMonth(), firstDate.getDate(), secondDate.getHours(),
                                    secondDate.getMinutes(), secondDate.getSeconds(), secondDate.getMilliseconds());
                            return firstDate;
                        }
                        /**
                         * @ngdoc method
