...
angular
        ...
        .factory(
                ...
                [
                        ...
                        function($timeout, $translate, Util, ConfigService, ArkCaseDashboard, DashboardService) {
                                    ...
                                    DashboardService
                                            .getConfig(
                                                    ...
                                                    function(data) {
                                                        ...
                                                        DashboardService.fixOldCode_removeLater(that.dashboardName,
                                                                that.scope.dashboard.model);
