...
angular
        ...
        .factory(
                ...
                [
                        ...
                        'uiGridConstants',
                        'Object.AuditService',
                        function($resource, $q, $translate, Util, LookupService, ApplicationConfigService, ObjectLookupService,
                                ObjectService, uiGridConstants, ObjectAuditService) {
                            var Service = {
                                Lookups : {
                            ...
                            Service.Grid.prototype = {
                                            ...
                                            function(data) {
                                                ...
                                                if (userNamePop == "userName" && _.get(config, 'columnDefs')) {
                                                    for (var i = 0; i < config.columnDefs.length; i++) {
                                                        if (Service.Lookups.USER_FULL_NAMES == config.columnDefs[i].lookup
                                                                || Service.Lookups.PARTICIPANT_NAMES == config.columnDefs[i].lookup) {
                                ...
                                setRowLookupDropDown : function(lookupName, lookupKeyName, lookupValueName, lookupArrayPath) {
                                    ...
                                    for (var i = 0; i < that.scope.config.columnDefs.length; i++) {
                                        if (lookupName == that.scope.config.columnDefs[i].lookup) {
                                            ...
                                            that.scope.gridOptions.columnDefs[i].cellFilter = "mapKeyValue: row.entity." + lookupArrayPath
                                                    + ":'" + lookupKeyName + "':'" + lookupValueName + "'";
                                        }
                                    }
                                }
                                ...
                                addEditButton : function(columnDefs, onClickEdit) {
                                    console
                                            .log("Warning: HelperUiGridService.Grid.addEditButton() is outdated. Please use addButton() instead");
                                    ...
                                    var columnDef = {
                                        ...
                                        cellTemplate : "<span><i class='fa fa-pencil fa-lg' style='cursor :pointer' ng-hide='grid.appScope.isReadOnly(row.entity)' ng-click='"
                                                + onClickEdit + "'></i></span>"
                                    };
                                ...
                                addDeleteButton : function(columnDefs, onClickDelete) {
                                    console
                                            .log("Warning: HelperUiGridService.Grid.addDeleteButton() is outdated. Please use addButton() instead");
                                    ...
                                    var columnDef = {
                                        ...
                                        width : 40,
                                        headerCellTemplate : "<span></span>",
                                        cellTemplate : "<span><i class='fa fa-trash-o fa-lg' style='cursor :pointer' ng-hide='grid.appScope.isReadOnly(row.entity)' ng-click='"
                                                + onClickDelete + "'></i></span>"
                                    };
                                    columnDefs.push(columnDef);
                                }
                                ...
                                addConfigurableButton : function(config, button) {
                                    ...
                                    var cellTemplate = "<a title='' class='inline animated btn btn-default btn-xs' ng-if='" + readOnlyFn
                                            + " == true'" + " ng-click='grid.appScope." + clickFn + "(row.entity)'";
                                ...
                                retrieveAuditData : function(objectType, objectId) {
                                    ...
                                    if (Util.goodPositive(objectId, false)) {
                                        var promiseQueryAudit = ObjectAuditService.queryAudit(objectType, objectId, Util.goodValue(
                                                this.scope.start, 0), Util.goodValue(this.scope.pageSize, 10), Util.goodMapValue(
                                                this.scope.sort, "by"), Util.goodMapValue(this.scope.sort, "dir"));
