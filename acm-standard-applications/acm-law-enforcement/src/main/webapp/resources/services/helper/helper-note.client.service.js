 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/helper/helper-note.client.service.js services/helper/helper-note.client.service.js}

 * Helper.NoteService provides common functionality related to the notes tables throughout the application
 */
angular.module('services').factory('Helper.NoteService', [ 'UtilService', 'Object.NoteService', 'Util.DateService', function(Util, ObjectNoteService, UtilDateService) {
    var Service = {
    ...
    Service.Note.prototype = {
        ...
        saveNote: function(note, rowEntity) {
            ...
            ObjectNoteService.saveNote(note).then(function(noteAdded) {
                if (rowEntity) {
