 ...
 * @description
 *
 * {@link /acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/config/application-config.client.service.js services/config/application-config.client.service.js}
...
angular.module('services').factory('ApplicationConfigService', [ '$resource', 'Acm.StoreService', 'UtilService', function($resource, Store, Util) {
    ...
    Service.PROPERTIES = {
        ...
        LOGOUTURL: 'application.properties.logoutUrl'
    };
