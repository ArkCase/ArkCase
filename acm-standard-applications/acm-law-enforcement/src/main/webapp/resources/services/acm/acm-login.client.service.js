...
angular.module('services').factory(
        'Acm.LoginService',
        [ '$q', '$state', '$injector', '$log', 'Acm.StoreService', 'UtilService', 'ConfigService', 'Analytics', 'WebSocketsListener',
                function($q, $state, $injector, $log, Store, Util, ConfigService, Analytics, WebSocketService) {
                    var Service = {
                        LocalCacheNames : {
