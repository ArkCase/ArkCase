 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/services/dialog/dialog-bootbox.client.service.js services/dialog/dialog-bootbox.client.service.js}
 *
 * This service provides wrap function to common bootbox dialogs
 */

angular.module('services').factory('Dialog.BootboxService', [ 'UtilService', '$q', function(Util, $q) {
