...
angular.module('cost-tracking').controller(
        ...
        [ '$scope', '$stateParams', 'CostTracking.InfoService', 'ObjectService', 'Helper.DocumentListTreeHelper',
                function($scope, $stateParams, CostTrackingInfoService, ObjectService, HelperDocumentListTreeHelper) {
