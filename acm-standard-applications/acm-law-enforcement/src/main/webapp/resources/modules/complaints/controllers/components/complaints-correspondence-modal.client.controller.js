...
angular.module('cases').controller('Complaints.MultiCorrespondenceModalController', [ '$scope', '$modalInstance', 'ObjectService', 'Admin.CMTemplatesService', function($scope, $modalInstance, ObjectService, CorrespondenceService) {
