...
/**
 * @ngdoc service
 * @name services:Complaint.FutureApprovalService
 *
 * @description
 *
 *
 * Complaint.FutureApprovalService provides functions for Complaints Approval Routing
 */
        ...
        [
                ...
                function($http) {
                    ...
                    var _getBusinessProcessVariableForObject = function(objectType, objectId, processVariable, readFromHistory) {
                        return $http({
                            method : 'GET',
                            url : 'api/latest/plugin/task/businessProcess/' + objectType + '/' + objectId + '/' + processVariable
                    ...
                    var _getBuckslipProcessesForChildren = function(objectType, objectId) {
                        return $http({
                            method : 'GET',
                            url : 'api/latest/plugin/task/objectType/' + objectType + '/objectId/' + objectId
                                    + '/buckslipProcessesForChildren'
                        });
                    };
