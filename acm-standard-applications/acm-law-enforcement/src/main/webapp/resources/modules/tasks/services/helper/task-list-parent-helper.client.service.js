                        ...
                        TaskTableComponent: function(arg) {
                            ...
                            that.scope.populateGridData = arg.populateGridData || function() {
                                ...
                                if (Util.goodPositive(currentObjectId, false)) {
                                    ObjectTaskService.queryChildTasks(that.objectType, currentObjectId, Util.goodValue(that.scope.start, 0), Util.goodValue(that.scope.pageSize, 10), Util.goodValue(that.scope.sort.by), Util.goodValue(that.scope.sort.dir)).then(function(data) {
