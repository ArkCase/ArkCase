 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/tasks/services/task-history.client.service.js modules/tasks/services/task-history.client.service.js}
 *
 * Task.HistoryService provides functions for Task history
 */
angular.module('tasks').factory('Task.HistoryService', [ '$resource', '$translate', 'Acm.StoreService', 'UtilService', function($resource, $translate, Store, Util) {
    var Service = $resource('api/latest/plugin', {}, {
        ...
        _queryTaskHistory: {
            method: 'GET',
            url: 'api/latest/plugin/task/history/:queryId/:adhoc',
            cache: false,
            isArray: true
        }
