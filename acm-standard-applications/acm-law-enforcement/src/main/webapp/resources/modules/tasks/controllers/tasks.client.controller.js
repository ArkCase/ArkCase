...
angular.module('tasks').controller(
        ...
        [
                ...
                function($scope, $stateParams, $state, $translate, Store, Util, ConfigService, TaskInfoService, ObjectService,
                    ...
                    var contentHelper = new HelperObjectBrowserService.Content({
                        ...
                        initComponentLinks : function(config) {
                            ...
                            $scope.adhocTaskLinks = HelperObjectBrowserService.createComponentLinks(config,
                                    ObjectService.ObjectTypes.ADHOC_TASK);
                        ...
                        selectComponentLinks : function(selectedTask) {
                            return (ObjectService.ObjectTypes.ADHOC_TASK == selectedTask.nodeType) ? $scope.adhocTaskLinks
                                    : $scope.taskLinks;
                        }
                    });
