...
angular.module('profile').controller('Profile.MfaDeleteFactorModalController', ['$scope', '$modalInstance'
    , '$translate', 'Profile.MfaService', 'factorInfo'
    , function ($scope, $modalInstance, $translate, ProfileMfaService, factorInfo) {
