 ...
 */
angular.module('profile').factory('Profile.UserInfoService',
        [ '$resource', '$q', 'UtilService', 'Authentication', '$translate', function($resource, $q, Util, Authentication, $translate) {
