...
angular.module('profile').controller('Profile.SubscriptionController', [ '$http', '$scope', 'Object.SubscriptionService', 'ConfigService', function($http, $scope, ObjectSubscriptionService, ConfigService) {
