                                                    ...
                                                    function(data) {
                                                        ...
                                                        if ($scope.userPicture.$error) {
                                                            ...
                                                            ProfilePictureService
                                                                    .changePic($scope.userPicture, userID)
                                                                    .success(
                                                                            function(fileInfo) {
                                                                            ...
                                                                            function() {
                                                                                ...
                                                                                messageService.error($translate
                                                                                        .instant('profile.picture.uploadError'));
                                                                            });
                                                        }
                                                    });
                                }
                                            ...
                                            .then(
                                                    function(data) {
                                                        ...
                                                        if ($scope.userSignature.$error) {
                                                            ...
                                                            ProfilePictureService
                                                                    .changeSignature($scope.userSignature, userID)
                                                                    .success(
                                                                            function(fileInfo) {
                                                                                var ecmFileID = fileInfo[0].fileId;
                                                                            ...
                                                                            function() {
                                                                                ...
                                                                                messageService.error($translate
                                                                                        .instant('profile.signature.uploadError'));
                                                                            });
                                                        }
                                                    });
                                }
