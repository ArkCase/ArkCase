...
angular.module('consultations').controller(
    'Consultations.TimeController',
    [ '$scope', '$stateParams', '$state', '$modal', '$translate', 'UtilService', 'ObjectService', 'ConfigService', 'Object.TimeService', 'Consultation.InfoService', 'Helper.UiGridService', 'Helper.ObjectBrowserService', 'FormsType.Service', 'TimeTracking.InfoService',
        function($scope, $stateParams, $state, $modal, $translate, Util, ObjectService, ConfigService, ObjectTimeService, ConsultationInfoService, HelperUiGridService, HelperObjectBrowserService, FormsTypeService, TimeTrackingInfoService) {
            ...
            var onObjectInfoRetrieved = function(objectInfo) {
                ...
                if (Util.goodPositive(currentObjectId, false)) {
                    $scope.newTimesheetParamsFromObject = {
                        _id: objectInfo.id,
                        _type: ObjectService.ObjectTypes.CONSULTATION,
                        _number: objectInfo.consultationNumber,
                        _title: objectInfo.title
                    };

                    ObjectTimeService.queryTimesheets(ObjectService.ObjectTypes.CONSULTATION, currentObjectId).then(function(timesheets) {
