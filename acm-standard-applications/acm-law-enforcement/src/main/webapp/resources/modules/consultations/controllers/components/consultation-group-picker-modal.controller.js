...
angular.module('consultations').controller('Consultations.GroupPickerController', [ '$scope', '$modal', '$modalInstance', '$translate', 'UtilService', 'ConfigService', '$q', 'owningGroup', function($scope, $modal, $modalInstance, $translate, Util, ConfigService, $q, owningGroup) {
    ...
    $scope.pickGroup = function() {
        ...
        params.header = $translate.instant("consultations.comp.groupPickerModal.searchGroupHeader");
        ...
        var modalInstance = $modal.open({
            templateUrl: "modules/consultations/views/components/consultation-group-picker-search-modal.client.view.html",
