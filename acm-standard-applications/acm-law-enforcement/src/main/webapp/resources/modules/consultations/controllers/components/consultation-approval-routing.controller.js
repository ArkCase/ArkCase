...
angular.module('consultations').controller(
    'Consultations.ApprovalRoutingController',
    [
        '$scope',
        '$stateParams',
        '$q',
        ...
        'Object.ModelService',
        'MessageService',
        function($scope, $stateParams, $q, $translate, $modal, Util, UtilDateService, ConfigService, ObjectService, ConsultationInfoService, HelperUiGridService, HelperObjectBrowserService, Authentication, TaskWorkflowService, PermissionsService, UserInfoService, ObjectTaskService, TaskInfoService,
            ...
            var onObjectInfoRetrieved = function(objectInfo) {
                ...
                if (Util.goodPositive(currentObjectId, false)) {
                    ...
                    ObjectTaskService.queryChildTasks(ObjectService.ObjectTypes.CONSULTATION, currentObjectId, 0, 100, '', '').then(function(data) {
