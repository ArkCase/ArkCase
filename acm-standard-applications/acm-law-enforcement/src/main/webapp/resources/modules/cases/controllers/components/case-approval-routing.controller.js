...
angular.module('cases').controller(
        ...
        [
                ...
                function($scope, $stateParams, $q, $translate, $modal, Util, UtilDateService, ConfigService, ObjectService,
                        CaseInfoService, HelperUiGridService, HelperObjectBrowserService, Authentication, TaskWorkflowService,
                    ...
                    var onObjectInfoRetrieved = function(objectInfo) {
                        ...
                        if (Util.goodPositive(currentObjectId, false)) {
                            ...
                            ObjectTaskService.queryChildTasks(ObjectService.ObjectTypes.CASE_FILE, currentObjectId, 0, 100, '', '').then(
                                    function(data) {
