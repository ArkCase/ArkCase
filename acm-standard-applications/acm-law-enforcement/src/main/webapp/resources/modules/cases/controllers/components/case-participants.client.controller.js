...
angular.module('cases').controller('Cases.ParticipantsController', [ '$scope', '$translate', 'Case.InfoService', 'ObjectService', function($scope, $translate, CaseInfoService, ObjectService) {
