 ...
 */
angular.module('services').factory('Person.PicturesService',
        [ '$resource', '$translate', 'Acm.StoreService', 'UtilService', 'Upload', function($resource, $translate, Store, Util, Upload) {
