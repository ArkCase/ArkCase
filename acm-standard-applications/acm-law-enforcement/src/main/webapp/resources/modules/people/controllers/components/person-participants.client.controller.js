...
angular.module('people').controller('People.ParticipantsController', [ '$scope', '$translate', 'Person.InfoService', 'ObjectService', function($scope, $translate, PersonInfoService, ObjectService) {
