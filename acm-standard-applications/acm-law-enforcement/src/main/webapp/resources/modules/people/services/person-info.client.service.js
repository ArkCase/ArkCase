...
angular.module('services').factory(
        'Person.InfoService',
        [ '$resource', '$translate', 'Acm.StoreService', 'UtilService', '$http', '$q', 'MessageService', 'CacheFactory',
                function($resource, $translate, Store, Util, $http, $q, MessageService, CacheFactory) {
