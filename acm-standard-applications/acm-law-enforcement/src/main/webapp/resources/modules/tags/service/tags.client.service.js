 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/tags/services/tags.client.service.js modules/tags/services/tags.client.service.js}
 *
 * The ClientsService provides clients  search functionality.
 */
angular.module('tags').factory('Tags.TagsService', [ '$q', '$http', 'Search.QueryBuilderService', 'SearchService', function($q, $http, SearchQueryBuilder, SearchService) {
    return {
        ...
        searchTags: function(searchParams) {
            ...
            if (searchParams.query) {
                ...
                var query = SearchQueryBuilder.buildFacetedSearchQuery(query, filters, n, start);
