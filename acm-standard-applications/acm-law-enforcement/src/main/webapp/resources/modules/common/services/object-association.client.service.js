 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/common/services/object-association.client.service.js modules/common/services/object-association.client.service.js}
 *
...
angular.module('services').factory(
        ...
        [
                ...
                function($resource, $translate, Util) {
                     ...
                     * @returns {Object} Promise
                     */
                    Service.createAssociationInfo = function(parentId, parentType, parentTitle, parentName, targetId, targetType,
                            targetTitle, targetName, associationType, inverseAssociationType) {
                        var association = {
                            parentId : parentId,
                            parentType : parentType,
