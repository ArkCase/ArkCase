angular
        .module('common')
        .controller(
                'Common.AddPersonModalController',
                [
                        '$scope',
                        '$modal',
                        '$modalInstance',
                        ...
                        function($scope, $modal, $modalInstance, $translate, ObjectLookupService, Util, ConfigService, params) {
                            ...
                            //if not set, than use 'true' as default
                            $scope.addNewEnabled = ('addNewEnabled' in params) && params.addNewEnabled != null ? params.addNewEnabled
                                    : true;
                            //if not set, than use 'true' as default
                            $scope.selectExistingEnabled = ('selectExistingEnabled' in params) && params.selectExistingEnabled != null ? params.selectExistingEnabled
                                    : true;
                            ...
                            $scope.isInvalid = function() {
                                return !Util.isEmpty(params.isEditPerson) && !Util.isEmpty($scope.type) && !Util.isEmpty(params.type)
