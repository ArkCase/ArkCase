angular.module('common').controller(
        ...
        [
                ...
                'params',
                function($scope, $modal, $modalInstance, $translate, ObjectLookupService, Util, ConfigService, OrganizationInfoService,
                        params) {
                    ...
                    $scope.onClickCancel = function() {
                        if ($scope.isSelectedParent && !!$scope.organization.parentOrganization
                                && !(!!$scope.organization.parentOrganization.organizationId)) {
                    ...
                    $scope.isInvalid = function() {
                        return !Util.isEmpty(params.isEditOrganization) && !Util.isEmpty($scope.type) && !Util.isEmpty(params.type)
                                && $scope.type.key === params.type;
                    };

                    $scope.notifyOrganizationParent = function(organizationAssociationType) {
                        $scope.hasSubCompany = !Util.isEmpty(organizationAssociationType) && !Util.isEmpty($scope.newOrganizationPicked)
                                && organizationAssociationType.key === "subCompany";
                    };
