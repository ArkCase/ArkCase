                ...
                [ function() {
                    return {
                        ...
                        buildFacetedSearchQuery : function(input, filters, n, start) {
                            return (filters ? (encodeURIComponent(input) + "&filters=" + encodeURIComponent(filters) + "&n=" + n
                                    + "&start=" + start) : (encodeURIComponent(input) + "&n=" + n + "&start=" + start));
                        },
                        ...
                        buildFacetedSearchQuerySorted : function(input, filters, join, n, start, sort) {
                            return (filters ? (encodeURIComponent(input) + "&filters=" + encodeURIComponent(filters) + "&join="
                                    + encodeURIComponent(join) + "&n=" + n + "&start=" + start + "&s=" + sort) : (encodeURIComponent(input)
                                    + "&join=" + encodeURIComponent(join) + "&n=" + n + "&start=" + start + "&s=" + sort));
                        },
                        ...
                        buildSafeFqFacetedSearchQuery : function(input, filters, n, start) {
                            return (filters ? (encodeURIComponent(input) + "&filters=" + filters.replace(/&fq=/gi, '%26fq%3D') + "&n=" + n
                                    + "&start=" + start) : (encodeURIComponent(input) + "&n=" + n + "&start=" + start));
                        },
                        ...
                        buildSafeFqFacetedSearchQuerySorted : function(input, filters, n, start, sort) {
                            return (filters ? (encodeURIComponent(input) + "&filters=" + filters.replace(/&fq=/gi, '%26fq%3D') + "&n=" + n
                                    + "&start=" + start + "&s=" + sort) : (encodeURIComponent(input) + "&n=" + n + "&start=" + start
                                    + "&s=" + sort));
                        }
