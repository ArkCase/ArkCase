...
angular.module('dashboard.tags', [ 'adf.provider' ]).config(function(dashboardProvider) {
    dashboardProvider.widget('tags', {
        ...
        [
                ...
                function($scope, $stateParams, $q, $translate, Util, CaseInfoService, ComplaintInfoService, TaskInfoService,
                        Authentication, DashboardService, ObjectService, ObjectTagsService, ConfigService, HelperObjectBrowserService,
                        HelperUiGridService) {
