...
angular.module('dashboard.calendar', [ 'adf.provider' ]).config(function(dashboardProvider) {
    dashboardProvider.widget('calendar', {
        ...
        [
                ...
                'MessageService',
                function($scope, $stateParams, $translate, CaseInfoService, ComplaintInfoService, HelperObjectBrowserService,
                        CalendarService, ObjectService, CalendarConfigurationService, MessageService) {
