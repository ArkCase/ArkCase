...
angular.module('dashboard.approvers', ['adf.provider'])
    ...
    .controller('Dashboard.ApproversController', ['$scope', 'config', '$state', '$translate', 'UtilService'
        , 'Dashboard.DashboardService', 'CostTracking.InfoService', 'TimeTracking.InfoService', 'Helper.ObjectBrowserService', '$stateParams', 'Helper.UiGridService', 'ObjectService', 'LookupService'
