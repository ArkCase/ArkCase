...
angular.module('dashboard').controller(
        'DashboardController',
        [ '$rootScope', '$scope', 'ConfigService', 'Dashboard.DashboardService', 'Helper.DashboardService',
                function($rootScope, $scope, ConfigService, DashboardService, DashboardHelper) {
