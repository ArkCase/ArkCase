    ...
    dashboardProvider.widget('documents', {
        ...
        .controller(
                ...
                [
                        ...
                        function($scope, config, $stateParams, $translate, DashboardService, HelperObjectBrowserService, Ecm,
                                CaseInfoService, ObjectService, ComplaintInfoService, TaskInfoService, Util, DocumentRepositoryInfoService,
                                CostTrackingInfoService) {
