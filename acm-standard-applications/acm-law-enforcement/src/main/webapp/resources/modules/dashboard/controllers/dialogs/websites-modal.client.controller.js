...
angular.module('cases').controller('Dashboard.WebsiteModalController', ['$scope', '$modalInstance', 'UtilService', 'websiteInfo', 'isEdit'
    , function ($scope, $modalInstance, Util, websiteInfo, isEdit) {
