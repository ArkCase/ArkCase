...
angular.module("dashboard.weather").controller(
        "Dashboard.WeatherController",
        [ "$scope", "$window", "params", "Dashboard.WidgetService", "ConfigService", "UtilService",
                function($scope, $window, params, WidgetService, ConfigService, Util) {
                    var vm = this;
