...
}).controller('Dashboard.DocReviewController', [ '$scope', '$stateParams', '$translate', 'Task.InfoService', 'Helper.ObjectBrowserService', 'Helper.UiGridService', function($scope, $stateParams, $translate, TaskInfoService, HelperObjectBrowserService, HelperUiGridService) {
