...
angular.module('dashboard.participants', [ 'adf.provider' ]).config(function(dashboardProvider) {
    dashboardProvider.widget('participants', {
        ...
        'Dashboard.ParticipantsController',
        [
                '$scope',
                '$stateParams',
                '$translate',
                ...
                function($scope, $stateParams, $translate, ObjectLookupService, CaseInfoService, ComplaintInfoService,
                        DocumentRepositoryInfoService, PersonInfoService, OrganizationInfoService, OrganizationAssociationService,
                        PersonAssociationService, HelperObjectBrowserService, HelperUiGridService) {
                    ...
                    var promiseTypes = ObjectLookupService.getParticipantTypes(module.name).then(function(participantTypes) {
