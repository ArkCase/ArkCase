 ...
 *@description
 *
 *{@link /acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/dashboard/services/dashboard..client.service.js modules/dashboard/services/dashboard.client.service.js}
 *
        ...
        [ '$resource', '$timeout', '$translate', '$q', 'Acm.StoreService', 'UtilService', 'Config.LocaleService', 'ArkCaseDashboard', 'Authentication', function($resource, $timeout, $translate, $q, Store, Util, LocaleService, ArkCaseDashboard, Authentication) {
            var Service = $resource('', {}, {
                ...
                queryActiveCaseFiles : {
                    method: 'GET',
                    url: 'api/v1/plugin/search/advancedSearch?q=object_type_s\\:CASE_FILE+' + 'AND+status_lcs\\:ACTIVE&start=:startWith&n=:pageSize&s=:sortBy :sortDir',
                    isArray: false,
                    data: ''
                },
