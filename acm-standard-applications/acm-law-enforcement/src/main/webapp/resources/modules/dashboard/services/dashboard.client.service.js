...
angular.module('dashboard').factory(
        ...
        [
                ...
                'ArkCaseDashboard',
                'Authentication',
                function($resource, $timeout, $translate, $q, Store, Util, LocaleService, ArkCaseDashboard, Authentication) {
                    var Service = $resource('', {}, {
                        ...
                        queryMyTasks : {
                            ...
                            url : 'api/v1/plugin/search/advancedSearch?q=(assignee_id_lcs\\::userId'
                                    + '+OR+candidate_group_ss\\::userGroupList)' + '+AND+object_type_s\\:TASK+'
