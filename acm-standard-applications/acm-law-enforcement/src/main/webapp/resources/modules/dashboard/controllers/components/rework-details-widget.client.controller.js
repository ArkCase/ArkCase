...
angular.module('dashboard.reworkDetails', [ 'adf.provider' ]).config(function(dashboardProvider) {
    dashboardProvider.widget('reworkDetails', {
        ...
        'Dashboard.ReworkDetailsController',
        [ '$scope', '$stateParams', '$translate', 'Task.InfoService', 'Helper.ObjectBrowserService', 'UtilService', 'Helper.UiGridService',
                function($scope, $stateParams, $translate, TaskInfoService, HelperObjectBrowserService, Util, HelperUiGridService) {
