                        ...
                        function($q, PermissionsService, ModuleService, Authentication) {
                            ...
                            this.addMenuItem = function(menuId, menuItemTitle, menuItemURL, menuItemType, menuItemUIRoute, isPublic, roles,
                                ...
                                context.menus[menuId].items.push({
                                    ...
                                    isPublic : ((isPublic === null || typeof isPublic === 'undefined') ? context.menus[menuId].isPublic
                                            : isPublic),
                            ...
                            this.addMenuItems = function(menuObjects) {
                                ...
                                $q.all([ appModulesPromise, userRolesPromise ]).then(
                                        function(data) {
                                            ...
                                            for (var i = 0; i < menuObjects.length; i++) {
                                                ...
                                                (function processMenuPermission(menuObj) {
                                                    ...
                                                    PermissionsService.getActionPermission(action, null).then(
                                                            function(moduleAllowedByActionPermission) {
                                                                ...
                                                                if (moduleObject != null) {
                                                                    ModuleService.getRolesForModulePrivilege(moduleObject.privilege)
                                                                            .then(
                                                                                    function(rolesForModule) {
                                                                                        angular.forEach(rolesForModule.data,
                                                                                                function(role) {
                                                                                                    angular.forEach(userRoles, function(
                                                                                                            userRole) {
                                                                                                        if (role === userRole) {
                            ...
                            this.addSubMenuItem = function(menuId, rootMenuItemURL, menuItemTitle, menuItemURL, menuItemUIRoute, isPublic,
                                ...
                                for ( var itemIndex in this.menus[menuId].items) {
                                    if (this.menus[menuId].items[itemIndex].link === rootMenuItemURL) {
                                        ...
                                        this.menus[menuId].items[itemIndex].items
                                                .push({
                                                    title : 'core.menus.' + menuId + '.' + menuItemURL,
                                                    link : menuItemURL,
                                                    uiRoute : menuItemUIRoute || ('/' + menuItemURL),
                                                    isPublic : ((isPublic === null || typeof isPublic === 'undefined') ? this.menus[menuId].items[itemIndex].isPublic
                                                            : isPublic),
