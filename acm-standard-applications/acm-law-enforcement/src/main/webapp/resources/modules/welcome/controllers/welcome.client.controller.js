...
angular.module('welcome').controller(
        'WelcomeController',
        [ '$state', '$window', '$translate', 'UtilService', 'Acm.LoginService', 'Acm.AppService', 'Config.LocaleService',
                function($state, $window, $translate, Util, AcmLoginService, AcmAppService, LocaleService) {
