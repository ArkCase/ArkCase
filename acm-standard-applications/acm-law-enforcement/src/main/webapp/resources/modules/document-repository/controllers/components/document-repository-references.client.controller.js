...
angular.module('document-repository').controller(
        ...
        [ '$scope', '$stateParams', '$modal', '$translate', 'UtilService', 'DocumentRepository.InfoService', 'Helper.UiGridService', 'Helper.ObjectBrowserService', 'ObjectAssociation.Service', 'ObjectService', 'ConfigService', 'MessageService',
                function($scope, $stateParams, $modal, $translate, Util, DocumentRepositoryInfoService, HelperUiGridService, HelperObjectBrowserService, ObjectAssociationService, ObjectService, ConfigService, MessageService) {
