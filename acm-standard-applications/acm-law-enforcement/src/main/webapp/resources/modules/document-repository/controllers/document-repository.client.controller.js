...
angular.module('document-repository').controller('DocumentRepositoryController',
        [ '$scope', '$stateParams', '$state', 'DocumentRepository.InfoService', 'ObjectService', 'Helper.ObjectBrowserService', function($scope, $stateParams, $state, DocumentRepositoryInfoService, ObjectService, HelperObjectBrowserService) {
