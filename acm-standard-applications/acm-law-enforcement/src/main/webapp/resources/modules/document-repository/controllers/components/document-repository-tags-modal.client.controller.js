...
angular.module('document-repository').controller('DocumentRepository.TagsModalController', ['$scope', '$q'
    , '$modalInstance', '$translate', 'ConfigService', 'Object.TagsService', 'MessageService', 'Search.AutoSuggestService'
    , function ($scope, $q, $modalInstance, $translate, ConfigService, ObjectTagsService, MessageService
        , AutoSuggestService) {
        ...
        ObjectTagsService.getTags().then(
            function (tags) {
        ...
        function checkTag(selectedTag) {
            ...
            if (!selectedTag.object_id_s) {
                ...
                if (tagsCreated.length == 0) {
                    ObjectTagsService.createTag(selectedTag.tags_s, selectedTag.tags_s, selectedTag.tags_s)
                        .then(
                            function (tagCreated) {
