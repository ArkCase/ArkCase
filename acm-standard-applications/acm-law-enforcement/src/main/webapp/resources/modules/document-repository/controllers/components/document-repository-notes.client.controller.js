...
angular.module('document-repository').controller(
        'DocumentRepository.NotesController',
        [ '$scope', '$stateParams', '$translate', 'ObjectService', 'DocumentRepository.InfoService', 'Helper.ObjectBrowserService',
                function($scope, $stateParams, $translate, ObjectService, DocumentRepositoryInfoService, HelperObjectBrowserService) {
