...
angular.module('admin').controller('Admin.DashboardConfigController', [ '$scope', 'Admin.DashboardConfigService', 'ConfigService', '$q', 'UtilService', '$translate', function($scope, dashboardConfigService, ConfigService, $q, Util, $translate) {
    ...
    $scope.onObjSelect = function(selectedObject) {
        ...
        initWidgetsData.selectedAuthorized = angular.copy($scope.widgetsMap[selectedObject.key].widgetAuthorizedRoles);
        initWidgetsData.selectedNotAuthorized = angular.copy($scope.widgetsMap[selectedObject.key].widgetNotAuthorizedRoles);
