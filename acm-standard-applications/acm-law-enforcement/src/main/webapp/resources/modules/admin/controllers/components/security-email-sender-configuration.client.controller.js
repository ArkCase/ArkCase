        ...
        .controller(
                ...
                [
                        ...
                        function($scope, EmailSenderConfigurationService, MessageService, $translate) {
                            ...
                            function sendEmailSenderConfiguration() {
                                EmailSenderConfigurationService.saveEmailSenderConfiguration($scope.emailSenderConfigDataModel).then(
                                        function(res) {
                            ...
                            $scope.save = function() {
                                if ($scope.emailSenderConfigDataModel.allowDocuments
                                        && !($scope.emailSenderConfigDataModel.allowAttachments || $scope.emailSenderConfigDataModel.allowHyperlinks)) {

                                    $scope.showMessage = true;

                                } else {
                                    sendEmailSenderConfiguration();
                                }
                            };
                        } ]);