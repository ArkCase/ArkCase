...
angular
        .module('admin')
        .controller(
                'Admin.CMMergeFieldsController',
                [
                        '$scope',
                        '$rootScope',
                        '$modal',
                        'Admin.CMMergeFieldsService',
                        'Helper.UiGridService',
                        'MessageService',
                        'LookupService',
                        'Acm.StoreService',
                        function($scope, $rootScope, $modal, correspondenceMergeFieldsService, HelperUiGridService, messageService,
                                LookupService, Store) {
                            ...
                            $scope.showVersion = function() {
                                ...
                                var mergeFieldVersionsPromise = correspondenceMergeFieldsService
                                        .retrieveMergeFieldsVersionsByType($scope.mergingType);

                                mergeFieldVersionsPromise
                                        .then(function(mergeFieldVersionsData) {
                                                        ...
                                                        controller : function($scope, $modalInstance) {
                                                            ...
                                                            $scope.onClickLoadVersion = function() {
                                                                ...
                                                                if (selectedRow.length == 1) {
                                                                    correspondenceMergeFieldsService
                                                                            .setActiveMergingVersion(selectedRow[0]).then(function() {
                                                                                messageService.succsessAction();
                            ...
                            function ReloadGrid() {
                                var mergeFieldsPromise = correspondenceMergeFieldsService
                                        .retrieveActiveMergeFieldsByType($scope.mergingType);
