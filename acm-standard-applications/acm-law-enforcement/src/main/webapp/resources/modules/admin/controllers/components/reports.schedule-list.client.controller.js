...
angular.module('admin').controller('Admin.ReportsScheduleListController', ['$scope', '$q', '$translate', '$filter',
    'LookupService', 'Util.DateService', 'Admin.ScheduleReportService', 'MessageService', 'Helper.UiGridService',
    function($scope, $q, $translate, $filter, LookupService, UtilDateService,
             ScheduleReportService, MessageService, HelperUiGridService) {
        ...
        $scope.config.$promise.then(function (config) {
            var scheduleReportConfig = _.find(config.components, {id: 'scheduleReportConfig'});
        ...
        $scope.extractEmailAddresses = function (rowEntity) {
            var emailAddresses = "";
            var emailParam = _.find(rowEntity.jobParams.jobParams, {name: '_SCH_EMAIL_TO'});
