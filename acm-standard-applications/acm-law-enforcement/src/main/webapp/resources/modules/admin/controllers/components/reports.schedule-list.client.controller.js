        ...
        [ '$scope', '$modal', '$q', '$translate', '$filter', 'LookupService', 'Util.DateService', 'Admin.ScheduleReportService', 'MessageService', 'Helper.UiGridService',
            ...
            $scope.editRow = function(rowEntity) {
                ...
                var report = {
                    ...
                    reportStartDate: moment(rowEntity.jobTrigger.startTime).format("MM/DD/YYYY"),
                    reportTime: rowEntity.jobTrigger.startTime,
                    reportEndDate: rowEntity.jobTrigger.endTime ? moment(rowEntity.jobTrigger.endTime).format("MM/DD/YYYY") : "",
