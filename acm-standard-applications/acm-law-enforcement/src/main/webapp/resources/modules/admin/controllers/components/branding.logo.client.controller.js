...
angular.module('admin').controller(
        'Admin.BrandingLogoController',
        [
                '$scope',
                'Admin.BrandingLogoService',
                '$translate',
                'MessageService',
                function($scope, brandingLogoService, $translate, messageService) {
                    ...
                    $scope.isFileTypeValid = function() {
                        ...
                        if (headerLogoType === null || loginLogoType === null
                                || (typeof (headerLogoType) == 'undefined' && typeof (loginLogoType) == 'undefined')) {
                            return null;
                        } else {
                            return true;
                        }
