                ...
                [
                        ...
                        function($scope, $modal, correspondenceService, HelperUiGridService, messageService, LookupService, Store) {
                                ...
                                var modalInstance = $modal
                                        .open({
                                            ...
                                            controller : [
                                                    ...
                                                    '$modalInstance',
                                                    'Admin.CMTemplatesService',
                                                    function($scope, $modalInstance, correspondenceService) {
                                                        ...
                                                        $scope.onClickOk = function(files) {
                                                            correspondenceService
                                                                    .uploadTemplateWithTimestamp(files)
                                                                    .then(
                                                                            function(result) {
                                                                                correspondenceService
                                                                                        .getTemplateData(
                                                                                                $scope.selectedRows.length > 0 ? $scope.selectedRows[0].templateId
                                                                                        ...
                                                                                        .then(
                                                                                                function(template) {
                                                                                                    ...
                                                                                                    correspondenceService.saveTemplateData(
                            ...
                            $scope.versionTemplate = function() {
                                ...
                                var templateVersionsPromise = correspondenceService
                                        .getTemplateVersionData($scope.selectedRows[0].templateId);

                                templateVersionsPromise
                                        .then(function(templateVersionData) {
                                            var modalInstance = $modal
                                                    .open({
                                                        scope : modalScope,
                                                        animation : true,
                                                        ...
                                                        controller : function($scope, $modalInstance) {
                                                            ...
                                                            angular.forEach(templateVersionData.data, function(row, index) {
                                                                row.downloadFileName = correspondenceService
                                                                        .downloadByFilename(row.templateFilename);
                                                            });
