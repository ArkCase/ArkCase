'use strict';
angular.module('admin').controller('Admin.SecurityExchangeConfigurationController', [ '$scope', 'Admin.ExchangeConfigurationService', 'MessageService', 'ConfigService', function($scope, ExchangeConfigurationService, MessageService, ConfigService) {
