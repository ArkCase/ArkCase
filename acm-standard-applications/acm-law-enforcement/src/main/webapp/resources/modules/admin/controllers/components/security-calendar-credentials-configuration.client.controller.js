...
angular.module('admin')
        .controller(
                'Admin.SecurityCalendarCredentialsConfigurationController',
                [
                        '$scope',
                        '$modal',
                        'Admin.CalendarCredentialsConfigurationService',
                        'Admin.CalendarConfigurationService',
                        'MessageService',
                        '$translate',
                        function($scope, $modal, CalendarCredentialsConfigurationService, CalendarConfigurationService, MessageService,
                                $translate) {
                            ...
                            var findInvalidOutlookFolderCreators = function() {
                                CalendarCredentialsConfigurationService.findInvalidOutlookFolderCreators().then(
                            ...
                            var saveCreator = function(creator, creatorIndex) {
                                ...
                                CalendarCredentialsConfigurationService.saveOutlookFolderCreator(creator).then(
                                        function successfulCallback() {
                                            MessageService.info($translate
                                                    .instant('admin.security.calendarCredentialsConfiguration.message.save.successful'));
                                        ...
                                        function failCallback() {
                                            MessageService.error($translate
                                                    .instant('admin.security.calendarCredentialsConfiguration.message.save.fail'));
                                            $scope.saveInProgress[creatorIndex] = false;
                                        });
                            };
                            ...
                            $scope.validateOutlookFolderCreator = function(creator, creatorIndex) {
                                ...
                                CalendarConfigurationService.validateCalendarConfigurationSystemEmail(emailCredentials).then(
                                        function successCallback(response) {
