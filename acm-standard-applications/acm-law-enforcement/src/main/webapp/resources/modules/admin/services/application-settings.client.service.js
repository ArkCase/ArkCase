 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/admin/services/labels.config.client.service.js modules/admin/services/application-settings.client.service.js }
 *
...
angular.module('admin').factory('Admin.ApplicationSettingsService', [ '$http', function($http) {
    return {
         ...
         * @returns {Object} updated Application settings value
         */
        getApplicationPropertiesConfig() {
            return $http({
                method: "GET",
                url: "api/latest/plugin/admin/app-properties"
            })
