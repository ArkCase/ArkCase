...
angular
        .module('admin')
        .controller(
                'Admin.NestedLookupParentController',
                [
                        '$scope',
                        '$translate',
                        '$modal',
                        ...
                        function($scope, $translate, $modal, ObjectLookupService, HelperUiGridService, Util, MessageService) {
                                    ...
                                    .then(function(config) {
                                        ...
                                        $scope.gridOptions = {
                                            ...
                                            rowTemplate : '<div grid="grid" class="ui-grid-draggable-row" draggable="true">'
                                                    ...
                                                    + 'class="ui-grid-cell cursor-view" ng-class="{ \'ui-grid-row-header-cell\': col.isRowHeader, \'custom\': true }"'
                            ...
                            $scope.parentLookupValueSelected = function(selectedParentLookupValue) {
                                ...
                                $scope.$broadcast('nested-lookup-parent-selected', $scope.selectedLookupDef, $scope.lookup,
