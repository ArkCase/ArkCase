...
angular
        ...
        .controller(
                ...
                [
                        ...
                        'ConfigService',
                        function($scope, $modal, $translate, $window, workflowsConfigService, messageService, HelperUiGridService,
                                ConfigService) {
                                ...
                                historyPromise.then(function(payload) {
                                    ...
                                    var modalInstance = $modal.open({
                                        ...
                                        controller : [
                                                ...
                                                'Helper.UiGridService',
                                                'params',
                                                function($scope, $modalInstance, HelperUiGridService, params) {
                                                    //initial values
                                                    ...
                                                    $scope.changeActive = function() {
                                                        if ($scope.activeBPMN
                                                                && $scope.activeBPMN.version != $scope.initialActiveBPMNVersion) {
