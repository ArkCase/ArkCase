...
angular.module('admin').controller(
        'Admin.UserNameConfigController',
        [
                '$scope',
                '$q',
                '$modal',
                ...
                function($scope, $q, $modal, ApplicationSettingsService, messageService) {
                    ...
                    $scope.applyChanges = function() {
                        if (oldPropertyValue != $scope.nameProperty) {
                            ApplicationSettingsService.setProperty(ApplicationSettingsService.PROPERTIES.DISPLAY_USERNAME,
                                    $scope.nameProperty);
...
angular.module('admin').controller('AdminUserInfoModalController',
        [ '$scope', '$modalInstance', '$modal', function($scope, $modalInstance, $modal) {
