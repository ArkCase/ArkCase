...
angular.module('admin').controller('Admin.TimesheetController',['$scope', '$modal', 'Helper.UiGridService', 'Admin.TimesheetConfigurationService',
                                    'MessageService', 'UtilService', 'Object.LookupService',
                                   function($scope, $modal, HelperUiGridService, TimesheetConfigurationService,
                                            MessageService, Util, ObjectLookupService) {
...
var saveConfig = function(){
    TimesheetConfigurationService.saveConfig($scope.timesheetConfig).then(
        function (response){
