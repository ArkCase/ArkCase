                                ...
                                resolve : {
                                    translatePartialLoader : [
                                            ...
                                            function($translate, $translatePartialLoader) {
                                                ...
                                                var components = [ 'admin', 'common', 'dashboard', 'audit', 'cases', 'complaints',
                                                        'cost-tracking', 'document-details', 'document-repository', 'notifications',
                                                        'organizations', 'people', 'profile', 'reports', 'search', 'subscriptions', 'tags',
                                                        'tasks', 'time-tracking' ];
