 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/admin/services/labels.config.client.service.js modules/admin/services/labels.config.client.service.js }
 *
 * The AdAdmin.LabelsConfigService provides Application Labels Config REST calls functionality
 */
angular.module('admin').factory('Admin.LabelsConfigService', [ '$resource', function($resource) {
