 ...
 * @description
 *
 * {@link /acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/modules/analytics/services/analytics.client.service.js modules/analytics/services/analytics.client.service.js}
 *
 * The BuildUrl is used for building ELK analytics url with given parameters.
 */
angular.module('analytics').factory('Analytics.BuildUrl', [ '$sce', '$http', '$browser', '$location', function($sce, $http, $browser, $location) {
    return {
