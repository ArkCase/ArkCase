...
angular.module('my-documents').controller(
        ...
        [ '$scope', '$stateParams', '$state', 'DocumentRepository.InfoService', 'ObjectService', 'Helper.ObjectBrowserService',
                function($scope, $stateParams, $state, DocumentRepositoryInfoService, ObjectService, HelperObjectBrowserService) {
