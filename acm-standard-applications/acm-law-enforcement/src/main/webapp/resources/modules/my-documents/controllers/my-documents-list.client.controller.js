...
angular.module('my-documents').controller(
        ...
        [
                ...
                'MessageService',
                "DocumentRepository.ListService",
                ...
                function($scope, $state, $stateParams, $translate, Util, ObjectService, HelperObjectBrowserService, MessageService,
                        DocumentRepositoryListService, DocumentRepositoryInfoService) {
                    ...
                    new HelperObjectBrowserService.Tree(
                            {
                                ...
                                updateTreeData : function(start, n, sort, filters, query, nodeData) {
                                    return DocumentRepositoryListService.updateDocumentRepositoryTreeData(start, n, sort, filters, query,
                                            nodeData);
                                },
