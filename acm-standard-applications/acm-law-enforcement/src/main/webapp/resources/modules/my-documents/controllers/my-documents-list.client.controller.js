...
angular.module('my-documents').controller(
        'MyDocumentsListController',
        [ '$scope', '$state', '$stateParams', '$translate', 'UtilService', 'ObjectService', 'Helper.ObjectBrowserService', 'MessageService', "DocumentRepository.ListService", "DocumentRepository.InfoService",
                function($scope, $state, $stateParams, $translate, Util, ObjectService, HelperObjectBrowserService, MessageService, DocumentRepositoryListService, DocumentRepositoryInfoService) {
