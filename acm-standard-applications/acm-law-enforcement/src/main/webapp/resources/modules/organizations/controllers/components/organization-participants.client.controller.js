...
angular.module('organizations').controller('Organizations.ParticipantsController', [ '$scope', '$translate', 'Organization.InfoService', 'ObjectService', function($scope, $translate, OrganizationInfoService, ObjectService) {
