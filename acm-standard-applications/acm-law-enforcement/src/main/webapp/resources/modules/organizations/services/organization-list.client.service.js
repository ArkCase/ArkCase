        ...
        [
                ...
                function($resource, $translate, Store, Util, ObjectService, ObjectListService) {
                    ...
                    Service.updateOrganizationsTreeData = function(start, n, sort, filters, query, nodeData) {
                        ObjectListService.updateObjectTreeData(Service.CacheNames.ORGANIZATION_LIST, start, n, sort, filters, query,
                                nodeData);
                    };
                                                    ...
                                                    function(doc) {
                                                        ...
                                                        if (nodeMaker) {
                                                            ...
                                                            node = {
                                                                ...
                                                                nodeStatusColor : Util.goodValue(doc.status_s)
                                                                        && (doc.status_s == "INACTIVE") ? "list-group-item-inactive-icon"
                                                                        : ""
                                                            };
                                                        }
