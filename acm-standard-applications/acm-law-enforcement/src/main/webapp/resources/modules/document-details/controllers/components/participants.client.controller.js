...
angular.module('document-details').controller(
        ...
        [
                ...
                'Object.ModelService',
                'EcmService',
                function($scope, $stateParams, $q, $modal, Util, ConfigService, HelperUiGridService, ObjectService,
                        ObjectParticipantService, Authentication, MessageService, $translate, ObjectLookupService, ObjectModelService,
                        EcmService) {
                    ...
                    $scope.retrieveGridData = function() {
                        if (Util.goodPositive($stateParams.id)) {
                            var promiseFileInfo = EcmService.getFile({
