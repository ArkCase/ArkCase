 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/blob/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/directives/table-view/table-height.directive.js directives/table-view/table-height.directive.js}
 *
                ...
                link : function($scope, element, attrs) {
                    ...
                    $scope.$watch('isDisplayed',
                            function(newValue, oldValue) {
                                ...
                                [ 'touchstart', 'touchmove', 'touchend', 'keydown', 'wheel', 'mousewheel', 'DomMouseScroll',
