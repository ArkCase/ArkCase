                        ...
                        getCommandHandlers : function(DocTree) {
                            ...
                            return [ {
                                ...
                                execute : function(nodes, args) {
                                    ...
                                    DocTree._addingFileNodes(nodes[0], names, names[0]).then(
                                            function(data) {
                                                var selectedFolderId = nodes[0].data.objectId;
                                                ObjectCorrespondenceService.createCorrespondence(template, DocTree.getObjType(),
                                                        DocTree.getObjId(), selectedFolderId).then(
                                                        function(uploadedFile) {
                                                            ...
                                                            if (DocTree.Validator.validateFolderList(folderList)) {
                                                                ...
                                                                if (!Util.isEmpty(uploadedFile)
                                                                        && DocTree.Validator.validateFancyTreeNodes(fileNodes)) {
