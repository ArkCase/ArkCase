...
angular.module('directives').directive(
        ...
        [
                ...
                '$timeout',
                function($q, $translate, $modal, $filter, $log, $injector, Store, Util, UtilDateService, ConfigService, UserInfoService, Ecm, EmailSenderConfigurationService, LocaleHelper, $timeout) {
