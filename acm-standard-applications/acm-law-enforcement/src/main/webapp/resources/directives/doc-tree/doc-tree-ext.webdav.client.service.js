 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/directives/doc-tree/doc-tree-ext.webdav.client.service.js directives/doc-tree/doc-tree-ext.webdav.client.service.js}
 *
...
angular.module('services').factory(
        ...
        [
                ...
                'TicketService',
                function($q, $browser, $location, Util, ObjectService, PermissionsService, LockingService, TicketService) {
                            ...
                            return [ {
                                ...
                                execute: function(nodes, args) {
                                    ...
                                    promiseTicket.then(function(ticketData) {
                                        ...
                                        LockingService.lockObject(fileId, ObjectService.ObjectTypes.FILE, ObjectService.LockTypes.WORD_EDIT_LOCK, false)
                                                .then(
                                                        function(lockedFile) {
                                                            ...
                                                            ITHit.WebDAV.Client.DocManager.EditDocument(appUrl + "webdav/" + acmTicket + "/" + ObjectService.ObjectTypes.FILE + "/" + ObjectService.LockTypes.WORD_EDIT_LOCK + "/" + node.data.objectId + node.data.ext, appUrl + "webdav",
