...
angular.module('services').factory(
        'DocTreeExt.Media',
        [ '$q', '$modal', '$translate', '$browser', 'UtilService', 'LookupService',
...
angular.module('directives').controller(
        'directives.DocTreeMediaDialogController',
        [ '$scope', '$modalInstance', 'UtilService', 'params', 'DocTreeExt.Media', '$modal', '$translate', '$sce',
