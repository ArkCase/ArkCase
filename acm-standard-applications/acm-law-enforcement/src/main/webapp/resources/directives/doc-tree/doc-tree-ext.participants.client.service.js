 ...
 * @description
 *
 * {@link https://***REMOVED***/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/directives/doc-tree/doc-tree-ext.paticipants.client.service.js directives/doc-tree/doc-tree-ext.email.participants.service.js}
 *
 * DocTree extensions for files and folders participants functions.
 */
angular.module('services').factory('DocTreeExt.Participants', [ '$q', '$modal', function($q, $modal) {
...
angular.module('directives').controller('directives.DocTreeParticipantsDialogController',
        [ '$scope', '$modalInstance', '$translate', 'UtilService', 'params', '$modal', 'ObjectService', 'Object.ParticipantService', function($scope, $modalInstance, $translate, Util, params, $modal, ObjectService, ObjectParticipantService) {
