        ...
        $scope.pickParticipant = function () {
            ...
            modalInstance.result.then(function (selected) {
                if (!Util.isEmpty(selected)) {
                	$scope.participant.participantLdapId = ($scope.participant.participantType === "owning group" || $scope.participant.participantType.lastIndexOf("group-", 0) === 0) ? selected.object_display_name_s : selected.object_id_s;
