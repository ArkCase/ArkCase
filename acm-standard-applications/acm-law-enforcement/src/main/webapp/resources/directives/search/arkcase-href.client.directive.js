                                ...
                                link : function(scope, element, attrs) {
                                    ...
                                    function buildUrl(objectData) {
                                        if (scope.url == undefined) {
                                            ...
                                            var objectType = scope.isParent ? parentReference.substring(parentReference.indexOf('-') + 1)
                                            ...
                                            if (objectType == ObjectService.ObjectTypes.TASK) {
                                                objectType = (Util.goodMapValue(objectData, "adhocTask_b", false)) ? ObjectService.ObjectTypes.ADHOC_TASK
