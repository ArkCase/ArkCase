                                            ...
                                            if (!scope.showActions) {
                                                            ...
                                                            .html(
                                                                    $compile(
                                                                            "<button class='btn btn-link btn-xs' type='button' ng-click='addSubgroup($event)' name='addSubgroup' tooltip=\"{{'admin.security.ldapConfig.addSubgroup' | translate}}\"><i class='fa fa-users'></i></button>"
                                                                                    ...
                                                                                    + "<button class='btn btn-link btn-xs' type='button' ng-click='removeGroupBtn($event)' name='removeGroup' tooltip=\"{{'admin.security.ldapConfig.removeGroup' | translate}}\"><i class='fa fa-trash-o'></i></button>")
                                                                            (scope));
                                                    if (scope.showSupervisor) {
                                                        $tdList
                                                                .eq(3)
                                                                .append(
                                                                        $compile(
                                                                                "<button class='btn btn-link btn-xs pull-left' type='button' ng-click='addSupervisor($event)' name='addSupervisor' tooltip=\"{{'admin.security.ldapConfig.addOrEditSupervisor' | translate}}\"><i class='fa fa-edit'></i></button>")
                                                                                (scope));
                                                    }
                                                }
                                                if (node.data.isMember && node.parent.data.object_sub_type_s != "LDAP_GROUP") {
                                                    $tdList
                                                            ...
                                                            .append(
                                                                    $compile(
                                                                            "<button class='btn btn-link btn-xs' type='button' ng-click='removeUserBtn($event)' name='removeMember' tooltip=\"{{'admin.security.ldapConfig.removeMember' | translate}}\"><i class='fa fa-trash-o'></i></button>")
                                                                            (scope));
                                                }
