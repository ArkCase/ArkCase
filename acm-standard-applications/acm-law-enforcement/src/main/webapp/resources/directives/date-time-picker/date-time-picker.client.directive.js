    ...
    return{
        ...
        link: function ($scope, element) {
            ...
            if (UtilService.isEmpty($scope.data)) {
                ...
                minYear = $scope.dateInPicker.getFullYear();
                ...
                $scope.dateInPicker = moment($scope.data).format(Util.DateService.defaultDateTimeFormat);
            ...
            $scope.saveDate = function () {
                ...
                $scope.dateInPicker = moment(editedDate).format(Util.DateService.defaultDateTimeFormat);
        ...
        controller: function ($scope) {
            $scope.$watch('data', function(){
                ...
                if (UtilService.isEmpty($scope.data)) {
                    ...
                    $scope.today = moment($scope.data).format(Util.DateService.defaultDateTimeFormat);
                }
            });
        }
    }
