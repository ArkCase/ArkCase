...
angular.module('directives').controller(
        'Directives.CoreCalendarDeleteEventController',
        [
                '$scope',
                '$modalInstance',
                'params',
                ...
                function($scope, $modalInstance, params, CalendarService, MessageService) {
                    ...
                    $scope.deleteEvent = function() {
                        CalendarService.deleteEvent($scope.objectType, $scope.objectId, $scope.eventDataModel.eventId,
                                $scope.deleteEventModel.deleteRecurring).then(function(res) {
