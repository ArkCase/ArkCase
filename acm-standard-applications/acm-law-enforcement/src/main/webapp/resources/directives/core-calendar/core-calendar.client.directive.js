 ...
 * @description
 *
 * {@link https://gitlab.armedia.com/arkcase/ACM3/tree/develop/acm-standard-applications/acm-law-enforcement/src/main/webapp/resources/directives/core-calendar/core-calendar.client.directive.js directives/core-calendar/core-calendar.client.directive.js}
 *
...
angular.module('directives').directive(
        ...
        [
                ...
                function($compile, $translate, $modal, uiCalendarConfig, CalendarService, ConfigService, MessageService,
                        CalendarUtilService, DateService, Util, LocaleHelper) {
                    return {
                        restrict : 'E',
                        ...
                        link : function(scope) {
                            ...
                            scope.eventClick = function(event, element, view) {
                                CalendarService.getCalendarEventDetails(scope.objectType, scope.objectId, event.id, false).then(
                                        function(res) {
                                            var modalInstance = $modal.open({
                                                animation : true,
                            ...
                            scope.uiConfig.calendar.events = function(start, end, timezone, callback) {
                                CalendarService.getCalendarEvents(DateService.dateToIso(start.toDate()),
                                        DateService.dateToIso(end.toDate()), scope.objectType, scope.objectId).then(function(res) {
                                    var events = [];
