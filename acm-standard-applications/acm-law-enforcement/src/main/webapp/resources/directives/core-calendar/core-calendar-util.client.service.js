...
angular.module('directives').factory(
        ...
        [
                ...
                function($filter, $translate, UtilService) {
                    ...
                    var getHtmlSummary = function(htmlCode, characters) {
                         ...
                         */
                        if (UtilService.isEmpty(htmlCode))
                            return;
                        var details;
                        /*
                    ...
                    var buildEventRecurrenceString = function(eventDetails) {
                        ...
                        durationString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.from') + ' ' + startTimeFormatedString + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.to') + ' '
                                + endTimeFormatedString;
                        ...
                        case 'DAILY':
                            if (!recurrenceDetails.everyWeekDay) {
                                if (recurrenceDetails.interval === 1) {
                                    patternString = patternString + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.day');
                                } else {
                                    patternString = patternString + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + recurrenceDetails.interval + ' '
                                            + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.days');
                                }
                            } else {
                                patternString = patternString + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.weekday');
                        ...
                        case 'WEEKLY':
                            ...
                            _.forEach(DAYS_WEEK_OPTIONS, function(dayOption) {
                                ...
                                if (selectedDayIndex !== -1) {
                                    ...
                                    if (successIndex === 1) {
                                        ...
                                        daysString = daysString + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.and') + ' ' + $translate.instant(dayOption.label);
                                    } else {
                            ...
                            if (recurrenceDetails.interval === 1) {
                                ...
                                weekNumString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + recurrenceDetails.interval + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.weeks') + ' '
                        ...
                        case 'MONTHLY':
                            if (!recurrenceDetails.weekOfMonth) {
                                var absoluteMonthlyPatternString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.day') + ' ' + recurrenceDetails.day + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.of')
                                        + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + recurrenceDetails.interval + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.months');

                                patternString = patternString + ' ' + absoluteMonthlyPatternString;
                            } else {
                                var weekOfMonth = _.find(DAY_OCCURRENCE_IN_MONTH_OPTIONS, function(o) {
                                    return o.value === recurrenceDetails.weekOfMonth;
                                });
                                var dayOfWeek = _.find(RELATIVE_RECURRENCE_DAY_OPTIONS, function(o) {
                                    return o.value === recurrenceDetails.dayOfWeek;
                                });
                                var relativeMonthlyPatternString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.the') + ' ' + $translate.instant(weekOfMonth.label) + ' ' + $translate.instant(dayOfWeek.label) + ' '
                                        + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.of') + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + recurrenceDetails.interval + ' '
                                        + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.months');
                        ...
                        case 'YEARLY':
                            var numYearString = '';
                            var month = _.find(MONTHS_OPTIONS, function(o) {
                                return o.value === recurrenceDetails.month;
                            });

                            if (!recurrenceDetails.weekOfMonth) {
                                if (recurrenceDetails.interval !== 1) {
                                    numYearString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every') + ' ' + recurrenceDetails.interval + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.years')
                                            + ' ' + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.on');
                                ...
                                var relativeYearlyPatternString = $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.the') + ' ' + $translate.instant(weekOfMonth.label) + ' ' + $translate.instant(dayOfWeek.label) + ' '
                                        + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.of') + ' ' + $translate.instant(month.label);
