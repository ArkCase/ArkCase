        ...
        .factory(
                ...
                [
                        ...
                        function($filter, $translate, UtilService) {
                             ...
                             * For more information about RRule library please visit https://github.com/jakubroztocil/rrule
                             */
                            var getRelativeYearlyRecurrenceRange = function(startDate, dayOuccurrenceInMonth, dayInMonth, month, interval,
                                    count) {
                            ...
                            var buildPopoverTemplate = function(calendarEvent) {
                                ...
                                var popoverTemplate = getHtmlSummary(calendarEvent.details, 50) + '</p>' + '<label>' + startLabel
                                        + '</label>' + startDateTime + '</br>' + '<label>' + endLabel + '</label>' + endDateTime;
                            ...
                            var buildEventRecurrenceString = function(eventDetails) {
                                ...
                                var startDateFormatedString = $filter('date')(moment(eventDetails.recurrenceDetails.startAt).toDate(),
                                        'MM/dd/yyyy');
                                startDateString = $translate
                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.effective')
                                        + ' ' + startDateFormatedString;
                                ...
                                if (recurrenceDetails.endBy || recurrenceDetails.endAfterOccurrances) {
                                    ...
                                    endDateString = $translate
                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.until')
                                ...
                                durationString = $translate
                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.from')
                                        + ' '
                                        + startTimeFormatedString
                                        + ' '
                                        + $translate.instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.to')
                                        + ' ' + endTimeFormatedString;

                                /*build pattern string*/
                                patternString = $translate
                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.occurs');
                                    ...
                                    if (!recurrenceDetails.everyWeekDay) {
                                        if (recurrenceDetails.interval === 1) {
                                            patternString = patternString
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every')
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.day');
                                        } else {
                                            patternString = patternString
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every')
                                                    + ' '
                                                    + recurrenceDetails.interval
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.days');
                                        }
                                    } else {
                                        patternString = patternString
                                                + ' '
                                                ...
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.weekday');
                                ...
                                case 'WEEKLY':
                                                        ...
                                                        if (selectedDayIndex !== -1) {
                                                            ...
                                                            if (successIndex === 1) {
                                                                ...
                                                                daysString = daysString
                                                                        + ' '
                                                                        + $translate
                                                                                .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.and')
                                    ...
                                    if (recurrenceDetails.interval === 1) {
                                        ...
                                        weekNumString = $translate
                                                ...
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.weeks')
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.on');
                                    }
                                    patternString = patternString + ' ' + weekNumString + ' ' + daysString;
                                    break;
                                case 'MONTHLY':
                                    if (!recurrenceDetails.weekOfMonth) {
                                        var absoluteMonthlyPatternString = $translate
                                                .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.day')
                                                + ' '
                                                + recurrenceDetails.day
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.of')
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every')
                                                + ' '
                                                ...
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.months');
                                        ...
                                        var relativeMonthlyPatternString = $translate
                                                .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.the')
                                                + ' '
                                                + $translate.instant(weekOfMonth.label)
                                                + ' '
                                                + $translate.instant(dayOfWeek.label)
                                                + ' '
                                                + $translate
                                                        .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.of')
                                                + ' '
                                ...
                                case 'YEARLY':
                                    ...
                                    if (!recurrenceDetails.weekOfMonth) {
                                        if (recurrenceDetails.interval !== 1) {
                                            numYearString = $translate
                                                    .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.every')
                                                    + ' '
                                                    + recurrenceDetails.interval
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.years')
                                                    + ' '
                                                    + $translate
                                                            .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.on');
                                        ...
                                        var absoluteYearlyPatternString = $translate.instant(month.label) + ' '
                                        ...
                                        var relativeYearlyPatternString = $translate
                                                .instant('common.directive.coreCalendar.recurrencePatternDialog.descriptionString.the')
                                                + ' '
                                                + $translate.instant(weekOfMonth.label)
                                                + ' '
