                ...
                [
                        ...
                        function($scope, $params, $modal, $modalInstance, CalendarService, MessageService, DateService,
                            ...
                            $scope.onTimeChanged = function(start, end) {
                                ...
                                eventDurationInMinutes = moment($scope.recurrenceTmpModel.end)
                                        .diff(moment($scope.recurrenceTmpModel.start)) / 60000;
                                $scope.validDuration = true;
                            };
                            ...
                            $scope.onDailyRecurrencePatternChange = function(dailyRecurrencePatternType) {
                                ...
                                if (dailyRecurrencePatternType === 'EVERY_DAY') {
                                    recurrenceRange = CalendarUtilService.getEveryDayRecurrenceRange($scope.recurrenceTmpModel.start,
                                            $scope.dailyRecurrence.interval, $scope.recurrenceTmpModel.endAfterOccurrances);

                                } else if (dailyRecurrencePatternType === 'EVERY_WEEKDAY') {
                                    recurrenceRange = CalendarUtilService.getEveryWeekdayRecurrenceRange($scope.recurrenceTmpModel.start,
                                ...
                                $scope.recurrenceTmpModel.end = moment($scope.recurrenceTmpModel.start).add(eventDurationInMinutes,
                                        'minutes').toDate();
                            ...
                            $scope.onWeeklyRecurrencePatternChange = function(day) {
                                ...
                                var recurrenceRange = CalendarUtilService.getWeeklyRecurrenceRange($scope.recurrenceTmpModel.start,
                                        $scope.selectedDayOfTheWeek, $scope.weeklyRecurrence.interval,
                                        $scope.recurrenceTmpModel.endAfterOccurrances);
                                $scope.recurrenceTmpModel.recurrenceEndBy = recurrenceRange.endBy;
                                $scope.recurrenceTmpModel.start = recurrenceRange.start;
                                $scope.recurrenceTmpModel.end = moment($scope.recurrenceTmpModel.start).add(eventDurationInMinutes,
                            ...
                            $scope.onMonthlyRecurrencePatternChange = function(monthlyRecurrencePatternType) {
                                ...
                                if (monthlyRecurrencePatternType === 'MONTHLY_ABSOLUTE') {
                                    recurrenceRange = CalendarUtilService.getAbsoluteMonthlyRecurrenceRange(
                                            $scope.recurrenceTmpModel.start, $scope.absoluteMonthlyRecurrence.day,
                                            $scope.absoluteMonthlyRecurrence.interval, $scope.recurrenceTmpModel.endAfterOccurrances);
                                } else if (monthlyRecurrencePatternType === 'MONTHLY_RELATIVE') {
                                    recurrenceRange = CalendarUtilService.getRelativeMonthlyRecurrenceRange(
                                            $scope.recurrenceTmpModel.start, $scope.relativeMonthlyRecurrence.dayOuccurrenceInMonth,
                                            $scope.relativeMonthlyRecurrence.day, $scope.relativeMonthlyRecurrence.interval,
                                            $scope.recurrenceTmpModel.endAfterOccurrances);
                                }
                            ...
                            $scope.onYearlyRecurrencePatternChange = function(yearlyRecurrencePatternType, monthValue) {
                                ...
                                if (monthValue) {
                                    ...
                                    $scope.maxDaysInMonth = CalendarUtilService.calculateDaysInMonth(monthIndex,
                                            $scope.recurrenceTmpModel.start.getFullYear());
                                }

                                if (yearlyRecurrencePatternType === 'YEARLY_ABSOLUTE') {
                                    recurrenceRange = CalendarUtilService.getAbsoluteYearlyRecurrenceRange($scope.recurrenceTmpModel.start,
                                            $scope.absoluteYearlyRecurrence.month, $scope.absoluteYearlyRecurrence.day,
                                            $scope.yearlyRecurrence.interval, $scope.recurrenceTmpModel.endAfterOccurrances);
                                } else if (yearlyRecurrencePatternType === 'YEARLY_RELATIVE') {
                                    recurrenceRange = CalendarUtilService.getRelativeYearlyRecurrenceRange($scope.recurrenceTmpModel.start,
                                            $scope.relativeYearlyRecurrence.dayOuccurrenceInMonth, $scope.relativeYearlyRecurrence.day,
                                            $scope.relativeYearlyRecurrence.month, $scope.yearlyRecurrence.interval,
                                            $scope.recurrenceTmpModel.endAfterOccurrances);
                                }
                            ...
                            var applyExistingMonthlyRecurrencePattern = function(recurrenceDetails) {
                                ...
                                if (!recurrenceDetails.weekOfMonth) {
                                    ...
                                    $scope.relativeMonthlyRecurrence = {
                                        dayOuccurrenceInMonth : CalendarUtilService
                                                .calculateDayOccurrenceInMonth($scope.recurrenceTmpModel.start.getDate()),
                            ...
                            var applyExistingYearlyRecurrencePattern = function(recurrenceDetails) {
                                ...
                                if (!recurrenceDetails.weekOfMonth) {
                                    ...
                                    $scope.maxDaysInMonth = CalendarUtilService.calculateDaysInMonth(recurrenceDetails.dayOfMonth,
                                            $scope.recurrenceTmpModel.start.getFullYear());
                                } else {
                            ...
                            var setDefaultYearlyRecurrencePattern = function() {
                                ...
                                $scope.maxDaysInMonth = CalendarUtilService.calculateDaysInMonth(
                                        $scope.recurrenceTmpModel.start.getMonth(), $scope.recurrenceTmpModel.start.getFullYear());
                            ...
                            $scope.setEventRecurrence = function() {
                                ...
                                if ($scope.validDuration) {
                                    var modalActionData = {
                                        recurrenceDataModel : buildRecurrenceDataModel($scope.recurrenceType,
                                                $scope.recurrenceTmpModel.recurrencePattern, $scope.recurrenceTmpModel.recurrenceRangeType),
