...
angular.module('directives').directive('searchModal',
        [ '$q', '$translate', 'UtilService', 'SearchService', 'Search.QueryBuilderService', '$injector', 'Person.InfoService', 'EcmService', 'ObjectService', function($q, $translate, Util, SearchService, SearchQueryBuilder, $injector, PersonInfoService, Ecm, ObjectService) {
            return {
