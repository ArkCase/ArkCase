...
module.exports = {
    ...
    assets : {
        lib : {
            css : [ 'lib/jquery-ui/themes/ui-lightness/jquery-ui.css', 'lib/bootstrap/dist/css/bootstrap.css',
                    'lib/bootstrap/dist/css/bootstrap-theme.css', 'lib/angular-ui-grid/ui-grid.css',
                    'lib/components-font-awesome/css/font-awesome.css', 'lib/fancytree/dist/skin-win8/ui.fancytree.css',
            ...
            js : [ 'lib/jquery/dist/jquery.min.js', 'lib/jquery-ui/jquery-ui.min.js', 'lib/bootstrap/dist/js/bootstrap.min.js',
                    ...
                    'lib/angular/angular.min.js', 'lib/angular-moment/angular-moment.min.js',
                    'lib/angular-resource/angular-resource.min.js', 'lib/angular-cookies/angular-cookies.min.js',
                    'lib/angular-animate/angular-animate.min.js', 'lib/angular-touch/angular-touch.min.js',
                    'lib/angular-sanitize/angular-sanitize.min.js', 'lib/angular-ui-router/release/angular-ui-router.min.js',
                    'lib/angular-bootstrap/ui-bootstrap-tpls.min.js', 'lib/angular-ui-grid/ui-grid.min.js',
                    'lib/angular-notify/dist/angular-notify.min.js', 'lib/angular-summernote/dist/angular-summernote.min.js',
                    ...
                    'lib/angular-dynamic-locale/dist/tmhDynamicLocale.min.js', 'lib/angular-xeditable/dist/js/xeditable.min.js',
                    'lib/angular-dashboard-framework/dist/angular-dashboard-framework.min.js', 'lib/Sortable/Sortable.min.js',
                    'lib/fancytree/dist/jquery.fancytree.min.js', 'lib/fancytree/dist/src/jquery.fancytree.table.js',
                    'lib/fancytree/dist/src/jquery.fancytree.gridnav.js', 'lib/fancytree/dist/src/jquery.fancytree.edit.js',
                    'lib/fancytree/dist/src/jquery.fancytree.dnd.js', 'lib/fancytree/dist/src/jquery.fancytree.filter.js',
                    'lib/ng-file-upload/ng-file-upload.min.js', 'lib/ng-file-upload-shim/ng-file-upload-shim.min.js',
                    'lib/ng-tags-input/ng-tags-input.min.js', 'lib/summernote/dist/summernote.min.js',
                    'lib/ui-contextmenu/jquery.ui-contextmenu.min.js', 'lib/bootbox/bootbox.js', 'lib/ngBootbox/ngBootbox.js', // Don't use minified version here. It is broken.
                    'lib/handsontable/dist/handsontable.full.min.js', 'lib/ngHandsontable/dist/ngHandsontable.min.js',
                    'lib/ace-builds/src-min-noconflict/ace.js', 'lib/angular-ui-ace/ui-ace.min.js',
                    'lib/fullcalendar/dist/fullcalendar.min.js', 'lib/fullcalendar/dist/gcal.js',
                    'lib/angular-ui-calendar/src/calendar.js', 'lib/Chart.js/Chart.min.js',
                    'lib/angular-chart.js/dist/angular-chart.min.js', 'lib/sockjs-client/dist/sockjs.min.js',
                    'lib/stomp-websocket/lib/stomp.min.js', 'lib/angular-hotkeys/build/hotkeys.js', 'lib/crypto-js/crypto-js.js',
                    ...
                    'lib/angular-pdfjs-viewer/dist/angular-pdfjs-viewer.js', 'lib/combodate/src/combodate.js']
        },
