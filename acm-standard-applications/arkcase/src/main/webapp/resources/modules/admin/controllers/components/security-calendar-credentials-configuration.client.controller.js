...
angular.module('admin').controller('Admin.SecurityCalendarCredentialsConfigurationController',
        [ '$scope', '$modal', 'Admin.CalendarCredentialsConfigurationService', 'Admin.CalendarConfigurationService', 'MessageService', '$translate', function($scope, $modal, CalendarCredentialsConfigurationService, CalendarConfigurationService, MessageService, $translate) {
            ...
            var findInvalidOutlookFolderCreators = function() {
                CalendarCredentialsConfigurationService.findInvalidOutlookFolderCreators().then(function successCallback(response) {
            ...
            var saveCreator = function(creator, creatorIndex) {
                ...
                CalendarCredentialsConfigurationService.saveOutlookFolderCreator(creator).then(function successfulCallback() {
            ...
            $scope.validateOutlookFolderCreator = function(creator, creatorIndex) {
                ...
                CalendarConfigurationService.validateCalendarConfigurationSystemEmail(emailCredentials).then(function successCallback(response) {
            ...
            $scope.saveOutlookFolderCreator = function(creator, creatorIndex) {
                ...
                if (creator.baseSystemEmailAddress !== creator.systemEmailAddress) {
                    ...
                    modalInstance.result.then(function modalClosed() {
