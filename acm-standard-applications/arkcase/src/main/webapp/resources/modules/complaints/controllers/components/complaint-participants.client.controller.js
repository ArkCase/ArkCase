...
angular.module('complaints').controller('Complaints.ParticipantsController', [ '$scope', '$translate', 'Complaint.InfoService', 'ObjectService', function($scope, $translate, ComplaintInfoService, ObjectService) {
