...
angular.module('dashboard.parentDocs', [ 'adf.provider' ]).config(function(dashboardProvider) {
    dashboardProvider.widget('parentDocs', {
        ...
        [ '$scope', '$q', 'config', '$stateParams', '$translate', 'Helper.ObjectBrowserService', 'EcmService', 'ObjectService', 'Task.InfoService', 'UtilService', function($scope, $q, config, $stateParams, $translate, HelperObjectBrowserService, Ecm, ObjectService, TaskInfoService, Util) {
