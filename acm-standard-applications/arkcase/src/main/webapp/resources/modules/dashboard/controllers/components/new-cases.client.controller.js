...
angular.module('dashboard.new-cases').controller('Dashboard.NewCasesController', [ '$scope', '$translate', 'Authentication', 'Dashboard.DashboardService', 'ConfigService', 'params', 'UtilService', function($scope, $translate, Authentication, DashboardService, ConfigService, params, Util) {
