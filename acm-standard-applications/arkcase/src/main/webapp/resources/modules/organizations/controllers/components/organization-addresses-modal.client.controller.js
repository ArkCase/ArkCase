angular.module('organizations').controller('Organizations.AddressesModalController', ['$scope', '$translate', '$modalInstance', 'Object.LookupService', 'params', 'UtilService', function ($scope, $translate, $modalInstance, ObjectLookupService, params, Util) {
