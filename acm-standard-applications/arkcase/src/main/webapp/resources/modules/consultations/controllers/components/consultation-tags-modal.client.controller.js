...
angular.module('consultations').controller(
    'Consultations.TagsModalController',
    [ '$scope', '$q', '$stateParams', '$modalInstance', 'ConfigService', 'Object.TagsService', 'Tags.TagsService', 'MessageService', '$translate', 'Search.AutoSuggestService',
        function($scope, $q, $stateParams, $modalInstance, ConfigService, ObjectTagsService, TagsService, messageService, $translate, AutoSuggestService) {
            ...
            ConfigService.getComponentConfig("consultations", "tags").then(function(componentConfig) {
            ...
            function checkTag(selectedTag) {
                ...
                if (!selectedTag.object_id_s) {
                    ...
                    if (tagsCreated.length == 0) {
                        ...
                        messageService.info($translate.instant('consultations.comp.tags.message.tagExists'));
