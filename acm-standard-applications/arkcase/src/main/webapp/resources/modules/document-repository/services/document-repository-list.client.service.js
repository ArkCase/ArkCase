 ...
 */
angular.module('services').factory('DocumentRepository.ListService', [ '$resource', '$translate', 'Acm.StoreService', 'UtilService', 'ObjectService', 'Object.ListService', function($resource, $translate, Store, Util, ObjectService, ObjectListService) {
    ...
    Service.updateDocumentRepositoryTreeData = function(start, n, sort, filters, query, nodeData) {
        ObjectListService.updateObjectTreeData(Service.CacheNames.DOC_REPO_LIST, start, n, sort, filters, query, nodeData);
    };
