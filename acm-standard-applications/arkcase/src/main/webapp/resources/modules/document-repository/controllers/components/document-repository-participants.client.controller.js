...
angular.module('document-repository').controller('DocumentRepository.ParticipantsController', [ '$scope', '$translate', 'DocumentRepository.InfoService', 'ObjectService', function($scope, $translate, DocumentRepositoryInfoService, ObjectService) {
