...
angular.module('people').controller('PeopleController',
        [ '$scope', '$state', '$stateParams', '$translate', 'UtilService', 'ConfigService', 'Person.InfoService', 'ObjectService', 'Helper.ObjectBrowserService', function($scope, $state, $stateParams, $translate, Util, ConfigService, PersonInfoService, ObjectService, HelperObjectBrowserService) {
