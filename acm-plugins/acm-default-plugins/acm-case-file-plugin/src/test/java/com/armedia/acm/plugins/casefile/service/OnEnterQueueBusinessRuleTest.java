...
public class OnEnterQueueBusinessRuleTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        Resource xls = new ClassPathResource("/rules/drools-on-enter-queue-rules.xlsx");
    ...
    public void coreArkCaseShouldNotLeaveCurrentQueue() throws Exception
    {
        ...
        context.setEnqueueName("any_name");

        OnEnterQueueModel<CaseFile, CaseFilePipelineContext> businessProcessModel = new OnEnterQueueModel<>();
