...
public class FindCaseFileEventsByIdAPIControllerTest extends EasyMockSupport
{
    private MockMvc mockMvc;
    private MockHttpSession mockHttpSession;

    private FindCaseFileEventsByIdAPIController unit;
    ...
    public void setUp() throws Exception
    {
        ...
        unit = new FindCaseFileEventsByIdAPIController();
    ...
    @Test
    public void findCaseFileEventsById() throws Exception
    {
        String ipAddress = "ipAddress";
        Long caseFileId = 500L;
        ...
        auditEvent.setObjectId(caseFileId);
        ...
        expect(mockAuditDao.findPagedResults(caseFileId, objectType, 0, 10)).andReturn(Arrays.asList(auditEvent));
        expect(mockAuditDao.countAll(caseFileId, objectType)).andReturn(1);
        expect(mockAuthentication.getName()).andReturn("user");

        replayAll();

        MvcResult result = mockMvc.perform(
                get("/api/latest/plugin/casefile/events/{caseFileId}", caseFileId)
