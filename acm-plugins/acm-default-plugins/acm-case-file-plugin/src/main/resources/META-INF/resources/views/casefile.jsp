                                    ...
                                    <div class="wrapper" id="tabTitle" style="display:none;">
                                        <div class="pull-left inline">
                                            <div class="btn-group">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" id="restrict" > <span data-i18n="casefile:header.buttons.restrict">Mark Restricted</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pull-right inline">
                                            <div class="btn-group">
                                                ...
                                                <button class="btn btn-default btn-sm" id="btnConsolidateCase" data-i18n="[data-title]casefile:header.buttons.consolidate-case" data-title="Consolidate Case" title="Consolidate Case"><i class="fa fa-random"></i>
