 ...
 *
 */
public class WitnessVictimPerson extends Person implements FrevvoPerson {

	private static final long serialVersionUID = 601307053343844821L;
	
	private String type;
	private String availabilityDifficulties;
	private List<String> personIdentificationKeys = Arrays.asList("availabilityDifficulties");
