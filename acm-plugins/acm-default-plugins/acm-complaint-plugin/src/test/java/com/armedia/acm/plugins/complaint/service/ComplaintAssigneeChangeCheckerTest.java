...
public class ComplaintAssigneeChangeCheckerTest extends EasyMockSupport {
	...
	public void testAcmObjectHistoryEvent() 
	{
		...
		String currentHistoryJson = "{\"complaintId\":" + objectId.toString() + ",\"complaintNumber\":\"" + objectName + "\",\"complaintTitle\":\"" + objectTitle + "\",\"participants\":[{\"className\":\"com.armedia.acm.services.participants.model.AcmParticipant\",\"participantType\":\"assignee\",\"participantLdapId\":\"" + newAssignee + "\"}],\"className\":\"com.armedia.acm.plugins.complaint.model.Complaint\"}";
		...
		String previousHistoryJson = "{\"complaintId\":" + objectId.toString() + ",\"complaintNumber\":\"" + objectName + "\",\"complaintTitle\":\"" + objectTitle + "\",\"participants\":[{\"className\":\"com.armedia.acm.services.participants.model.AcmParticipant\",\"participantType\":\"assignee\",\"participantLdapId\":\"" + oldAssignee + "\"}],\"className\":\"com.armedia.acm.plugins.complaint.model.Complaint\"}";
