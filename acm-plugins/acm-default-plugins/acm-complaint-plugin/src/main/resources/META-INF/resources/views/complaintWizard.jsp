...
<t:layout>
    <jsp:attribute name="endOfHead">
        <title>Complaint | ACM | Armedia Case Management</title>
    </jsp:attribute>

    <jsp:body>
        <div id="content">
            <div id="divComplaint">Here we are in the new complaint wizard</div>
            <form name="complaintWizard" method="POST" action="<c:url value='/plugin/complaint'/>"
                ...
                <input type="text" name="originator.givenName" id="originator.givenName"
                       value="${complaint.originator.givenName}"/>
                <br/>

                <label for="originator.familyName">Originator last name: </label>
                <input type="text" name="originator.familyName" id="originator.familyName"
                       value="${complaint.originator.familyName}"/>
                <br/>
                ...
                <input type="hidden" name="originator.status" id="originator.status"
                       value="${complaint.originator.status}"/>
