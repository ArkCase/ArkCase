...
//        var record = {};
//        record.id = c.originator.id;
//        record.title = c.originator.title;
//        record.givenName = c.originator.givenName;
//        record.familyName = c.originator.familyName;
//        record.type = c.originator.type;
//        record.description = c.originator.description;
//        this.$divInitiator.jtable('updateRecord', record);
            ...
            ,fields: {
                ...
                ,subTables: {
                    ...
                    ,display: function (commData) {
                        ...
                        $a.click(function (e) {
                            ComplaintDetail.Object._toggleInitiatorDevices($s, $a);
                            e.preventDefault();
                        });
                        $b.click(function (e) {
                            ComplaintDetail.Object._toggleInitiatorOrganizations($s, $b);
                            e.preventDefault();
                        });
                        $c.click(function (e) {
                            ComplaintDetail.Object._toggleInitiatorLocations($s, $c);
                            e.preventDefault();
                        });
                        $d.click(function (e) {
                            ComplaintDetail.Object._toggleInitiatorAliases($s, $d);
                            e.preventDefault();
                        });
