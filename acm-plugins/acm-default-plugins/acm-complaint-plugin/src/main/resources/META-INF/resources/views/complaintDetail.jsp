...
<jsp:attribute name="endOfBody">
    ...
    <script type="text/javascript" src="<c:url value='/resources/js/complaint/detail/complaintDetailPage.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/complaint/detail/complaintDetailRule.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/complaint/detail/complaintDetailService.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/complaint/detail/complaintDetailCallback.js'/>"></script>
