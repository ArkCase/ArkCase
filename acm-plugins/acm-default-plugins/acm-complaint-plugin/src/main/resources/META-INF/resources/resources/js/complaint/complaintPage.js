...
//            }
        ...
        Complaint.Object.setHtmlUlComplaints(html);
        Complaint.Object.registerClickListItemEvents();

        Complaint.Event.doClickLnkListItem();
    }

    ,buildTableDocDocuments: function(c) {
        Complaint.Object.resetTableDocDocuments();
        var urlBase = App.getContextPath() + Complaint.Service.API_DOWNLOAD_DOCUMENT;
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (obj.targetType == "FILE") {
                    var row = "<tr class='odd gradeA'>"
                        ...
                        + "<td>" + obj.status + "</td>"
                        + "</tr>";
                    Complaint.Object.addRowTableDocDocuments(row);
                }
            } //for
        }
    }
...
//        Complaint.Object.resetTableTasks();
...
//                + "</select></td>"
//                + "</tr>";
//            Complaint.Object.addRowTableTasks(row);
//        }
//
//        Complaint.Object.registerChangeSelTasksEvents();
//    }
