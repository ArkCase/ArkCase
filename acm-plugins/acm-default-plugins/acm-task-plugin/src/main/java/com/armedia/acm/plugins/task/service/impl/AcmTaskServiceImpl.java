...
public class AcmTaskServiceImpl implements AcmTaskService
{
    ...
    @Override
    public String getBusinessProcessVariableByObjectType(String objectType, Long objectId, String processVariableKey, boolean readFromHistory, Authentication authentication) throws AcmTaskException {
        ...
        Long businessProcessId = (buckslipProcesses != null && buckslipProcesses.size()>0 && !buckslipProcesses.get(0).getBusinessProcessId().isEmpty()) ?
                Long.valueOf(buckslipProcesses.get(0).getBusinessProcessId()) : getCompletedBuckslipProcessIdForObjectFromSolr(objectType, objectId, authentication);
