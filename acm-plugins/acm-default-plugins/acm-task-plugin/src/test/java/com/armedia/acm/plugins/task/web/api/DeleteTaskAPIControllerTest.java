...
public class DeleteTaskAPIControllerTest extends EasyMockSupport
{
    ...
    private DeleteTaskAPIController unit;
    ...
    public void setUp() throws Exception
    {
        ...
        unit = new DeleteTaskAPIController();
    ...
    public void deleteTask() throws Exception
    {
        ...
        expect(mockTaskDao.deleteTask(eq(mockAuthentication), eq(taskId))).andReturn(found);
        ...
        MvcResult result = mockMvc.perform(
                post("/api/v1/plugin/task/deleteTask/{taskId}", taskId)
        ...
        AcmTask deletedTask = objectMapper.readValue(returned, AcmTask.class);

        assertNotNull(deletedTask);
        assertEquals(deletedTask.getTaskId(), taskId);
    ...
    @Test
    public void deleteTask_exception() throws Exception
    {
        Long taskId = 500L;
        String ipAddress = "ipAddress";
        ...
        expect(mockTaskDao.deleteTask(eq(mockAuthentication), eq(taskId))).andThrow(new AcmTaskException("testException"));
        mockTaskEventPublisher.publishTaskEvent(capture(capturedEvent));
        // MVC test classes must call getName() somehow
        expect(mockAuthentication.getName()).andReturn("user").atLeastOnce();
