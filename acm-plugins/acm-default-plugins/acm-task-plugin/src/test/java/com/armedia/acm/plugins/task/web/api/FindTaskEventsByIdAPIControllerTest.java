...
public class FindTaskEventsByIdAPIControllerTest extends EasyMockSupport
{
    private MockMvc mockMvc;
    private MockHttpSession mockHttpSession;

    private FindTaskEventsByIdAPIController unit;
    ...
    public void setUp() throws Exception
    {
        ...
        unit = new FindTaskEventsByIdAPIController();
    ...
    @Test
    public void findTaskEventsById() throws Exception
    {
        ...
        expect(mockAuditDao.findPagedResults(taskId, objectType, 0, 10)).andReturn(Arrays.asList(auditEvent));
        expect(mockAuditDao.countAll(taskId, objectType)).andReturn(1);
        expect(mockAuthentication.getName()).andReturn("user");

        replayAll();

        MvcResult result = mockMvc.perform(
                get("/api/latest/plugin/task/events/{taskId}", taskId)
