...
public class CleanHistoryJobDescriptor extends AcmJobDescriptor
{
    ...
    public HistoryCleanService getHistoryCleanService()
    {
        return historyCleanService;
    }

    public void setHistoryCleanService(HistoryCleanService historyCleanService)
    {
