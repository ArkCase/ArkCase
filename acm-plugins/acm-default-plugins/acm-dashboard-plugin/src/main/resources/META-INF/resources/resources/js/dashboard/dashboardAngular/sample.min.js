...
angular.module("ui.bootstrap", ["ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope",
    ...
    function($scope, $http, localStorageService, model) {
        $scope.name = "sample-01", $scope.model = angular.fromJson(model), $scope.collapsible = !1, $scope.$on("adfDashboardChanged", function(event, name, model) {
            ...
            var url = App.getContextPath() + "/api/latest/plugin/dashboard/set",
    ...
    function($scope, $filter, $http, ngTableParams) {
        var url = App.getContextPath() + "/api/v1/plugin/document/assignedToUser/" + App.getUserName();
        var nOfRows = 5;
        ...
        $http.get(url).success(function(rawData) {
            dataI=_.map(rawData,function(row){
                row=_.clone(row),
                row.itemUrl = App.getContextPath() + "/plugin/casefile/";
                return row
            })
...
Showdown.converter = function(converter_options) {
    ...
    function(dashboardProvider) {
        var widget = {
            ...
            reload: !0,
            resolve: {
                cases: function(ecmsServiceCases, config) {
                    return ecmsServiceCases.get(config.period)
                }
            },
            edit: {
    ...
    function($templateCache) {
        "use strict";
        $templateCache.put("scripts/widgets/ecms/ecms.html", '<div><div class="alert alert-info" ng-if="!showChartCase"><p style="text-align:center; font-size:large;">{{chartTitle}}</p></br><p style="text-align:center;">Currently, there are no outstanding cases</p></div><div ng-if="showChartCase"><highchart id="chart1" config="chartConfig"></highchart></div></div>'),
        $templateCache.put("scripts/widgets/ecms/edit.html", '<form role="form"><div class="form-group">' +
