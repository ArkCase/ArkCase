...
/**
 * Created by riste.tutureski on 9/8/2015.
 */
public interface CaptureConstants
{
    ...
    String XML_BATCH_DESCRIPTION_KEY = "Description";
    String XML_BATCH_NAME_KEY = "Name";
    String XML_BATCH_VALUE_KEY = "Value";
    String XML_BATCH_IDENTIFIER_KEY = "Identifier";
