 ...
 */
public class GetObjectByIdQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public GetObjectByIdQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    @Override
    public Object send(Map<String, Object> props)
    {
        String queueName = "seda:" + repositoryID + "-getObjectByIdQueue?timeout=" + timeout;
