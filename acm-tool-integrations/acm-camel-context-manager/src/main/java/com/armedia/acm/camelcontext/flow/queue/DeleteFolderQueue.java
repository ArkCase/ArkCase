 ...
 */
public class DeleteFolderQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public DeleteFolderQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    {
        String queueName = "seda:" + repositoryID + "-deleteFolderQueue?timeout=" + timeout;
