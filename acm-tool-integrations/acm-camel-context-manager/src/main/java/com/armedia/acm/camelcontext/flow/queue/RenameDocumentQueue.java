 ...
 */
public class RenameDocumentQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public RenameDocumentQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    {
        String queueName = "seda:" + repositoryID + "-renameDocumentQueue?timeout=" + timeout;
