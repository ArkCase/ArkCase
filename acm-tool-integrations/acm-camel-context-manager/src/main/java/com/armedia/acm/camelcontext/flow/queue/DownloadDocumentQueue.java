 ...
 */
public class DownloadDocumentQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public DownloadDocumentQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    {
        String queueName = "seda:" + repositoryID + "-downloadDocumentQueue?timeout=" + timeout;
