 ...
 */
public class RenameDocumentRoute extends RouteBuilder implements ArkCaseRoute
{
    ...
    public void configure()
    {
        ...
        from("seda:" + repositoryId + "-renameDocumentQueue?timeout=" + timeout).setExchangePattern(ExchangePattern.InOut)
                .process(exchange -> {
                    ...
                    exchange.getIn().getHeaders().put(PropertyIds.NAME, map.get("newFileName"));
