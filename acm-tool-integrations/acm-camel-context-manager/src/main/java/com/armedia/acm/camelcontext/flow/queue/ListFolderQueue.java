 ...
 */
public class ListFolderQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public ListFolderQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    {
        String queueName = "seda:" + repositoryID + "-listFolderQueue?timeout=" + timeout;
