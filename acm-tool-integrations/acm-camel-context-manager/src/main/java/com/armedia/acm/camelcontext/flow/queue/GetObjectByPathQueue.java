 ...
 */
public class GetObjectByPathQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public GetObjectByPathQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    public Object send(Map<String, Object> props) throws ArkCaseFileRepositoryException {
        String queueName = "seda:" + repositoryID + "-getObjectByPathQueue?timeout=" + timeout;
