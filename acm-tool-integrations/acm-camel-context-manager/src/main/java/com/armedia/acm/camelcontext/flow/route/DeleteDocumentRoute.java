 ...
 */
public class DeleteDocumentRoute extends ArkCaseAbstractRoute
{
    ...
    public void configure()
    {
        ...
        from("seda:" + getRepositoryId() + "-deleteDocumentQueue?timeout=" + getTimeout()).setExchangePattern(ExchangePattern.InOut)
                .process(exchange -> {
                    ...
                    exchange.getIn().getHeaders().put(CamelCMISConstants.ALL_VERSIONS, getRouteProperties().get(ArkCaseCMISConstants.ALL_VERSIONS));
