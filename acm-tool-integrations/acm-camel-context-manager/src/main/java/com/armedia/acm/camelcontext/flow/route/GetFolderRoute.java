 ...
 */
public class GetFolderRoute extends ArkCaseAbstractRoute
{
    ...
    public void configure()
    {
        ...
        from("seda:" + getRepositoryId() + "-getFolderQueue?timeout=" + getTimeout()).setExchangePattern(ExchangePattern.InOut)
                .process(exchange -> {
