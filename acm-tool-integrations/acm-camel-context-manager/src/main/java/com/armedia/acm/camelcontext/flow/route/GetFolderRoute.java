 ...
 */
public class GetFolderRoute extends RouteBuilder implements ArkCaseRoute
{
    ...
    public void configure() throws Exception
    {
        onException(Exception.class).handled(true)
                .process(x -> {
                    ...
                    log.error("Exception while fetching folder: {}", causeMessage, exception);
                });

        from("seda:" + repositoryId + "-getFolderQueue?timeout=" + timeout).setExchangePattern(ExchangePattern.InOut)
                .process(exchange -> {
                    ...
                    exchange.getIn().getHeaders().put(CamelCMISConstants.CMIS_ACTION, CamelCMISActions.GET_FOLDER);
