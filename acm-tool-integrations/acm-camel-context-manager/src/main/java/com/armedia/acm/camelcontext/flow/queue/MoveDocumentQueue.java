 ...
 */
public class MoveDocumentQueue implements ArkCaseCMISQueue
{
    private ProducerTemplate producerTemplate;
    private String repositoryID;
    private Long timeout;

    public MoveDocumentQueue(ProducerTemplate producerTemplate, String repositoryID, String timeout)
    {
    ...
    {
        String queueName = "seda:" + repositoryID + "-moveDocumentQueue?timeout=" + timeout;
