 ...
 */
public class MoveDocumentRoute extends ArkCaseAbstractRoute
{
    ...
    public void configure()
    {
        ...
        from("seda:" + getRepositoryId() + "-moveDocumentQueue?timeout=" + getTimeout()).setExchangePattern(ExchangePattern.InOut)
                .process(exchange -> {
                    ...
                    exchange.getIn().getHeaders().put(CamelCMISConstants.CMIS_SOURCE_FOLDER_ID,
                            routeProperties.get(ArkCaseCMISConstants.SOURCE_FOLDER_ID));
