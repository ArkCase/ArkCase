 ...
 */
public class ConfigurationUpdateNotifier
{
    ...
    public void notifyChange(Message<Map<String, Object>> message)
    {
        log.trace("Sending configuration update message: [{}]", message);
        template.convertAndSend("/topic/configuration/updated", message.getPayload());
    }
