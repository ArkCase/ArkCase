...
public class ProxyServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        {
            // Execute the request
            logger.warn("proxy " + method + " uri: " + servletRequest.getRequestURI() + " -- " + proxyRequest.getRequestLine().getUri());
    ...
    protected String rewriteUrlFromRequest(HttpServletRequest servletRequest)
    {
        ...
        {
            String pathInfo = servletRequest.getRequestURI().substring(servletRequest.getContextPath().length());
