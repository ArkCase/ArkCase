package com.armedia.acm.tool.transcribe.factory;
 ...
 */
public class TranscribeProviderFactory implements MediaEngineProviderFactory
{
    private Map<String, TranscribeIntegrationService> providers;

    @Override
    public TranscribeIntegrationService getProvider(String name)
    {
