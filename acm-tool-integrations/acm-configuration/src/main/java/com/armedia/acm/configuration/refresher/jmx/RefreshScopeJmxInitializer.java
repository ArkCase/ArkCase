...
import com.armedia.acm.configuration.scope.RefreshScope;
...
@Configuration
public class RefreshScopeJmxInitializer
{
    @Autowired
    ...
    public MBeanExporter getMBeanExporter()
    {
        ...
        beans.put("configuration:name=configuration-service,type=com.armedia.acm.configuration.RefreshScope,artifactId=configuration-service",
                new RefreshScopeFacadeJmx(refreshScope));
