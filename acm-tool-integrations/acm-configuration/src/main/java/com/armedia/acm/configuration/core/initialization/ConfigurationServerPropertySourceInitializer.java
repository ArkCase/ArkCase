...
import com.armedia.acm.configuration.core.propertysource.ConfigServerPropertyResource;
...
@Component("configSource")
@DependsOn("bootstrapConfig")
public class ConfigurationServerPropertySourceInitializer implements Ordered, InitializingBean
{
