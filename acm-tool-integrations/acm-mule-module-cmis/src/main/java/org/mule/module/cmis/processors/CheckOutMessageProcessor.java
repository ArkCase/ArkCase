...
/**
 * CheckOutMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#checkOut(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedDocument = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    CheckOutMessageProcessor.class.getDeclaredField("_documentType").getGenericType(), null, document));
            final String _transformedDocumentId = ((String) evaluateAndTransform(getMuleContext(), event,
                    CheckOutMessageProcessor.class.getDeclaredField("_documentIdType").getGenericType(), null, documentId));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("checkOut"), event, e);
        }
    }
