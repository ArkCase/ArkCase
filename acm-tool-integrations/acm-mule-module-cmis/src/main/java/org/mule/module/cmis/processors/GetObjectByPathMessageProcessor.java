...
/**
 * GetObjectByPathMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getObjectByPath(java.lang.String)} method in {@link CMISCloudConnector
 * }. For each argument there is a field in this processor to match it. Before invoking the actual method the processor
 * will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedPath = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetObjectByPathMessageProcessor.class.getDeclaredField("_pathType").getGenericType(), null, path));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getObjectByPath"), event, e);
        }
    }
