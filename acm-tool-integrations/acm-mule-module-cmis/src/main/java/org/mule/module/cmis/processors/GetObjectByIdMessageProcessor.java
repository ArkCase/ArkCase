...
/**
 * GetObjectByIdMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getObjectById(java.lang.String)} method in {@link CMISCloudConnector
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetObjectByIdMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getObjectById"), event, e);
        }
    }
