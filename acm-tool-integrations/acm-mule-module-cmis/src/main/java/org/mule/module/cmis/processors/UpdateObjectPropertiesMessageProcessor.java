...
/**
 * UpdateObjectPropertiesMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#updateObjectProperties(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.util.Map)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedCmisObject = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    UpdateObjectPropertiesMessageProcessor.class.getDeclaredField("_cmisObjectType").getGenericType(), null, cmisObject));
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    UpdateObjectPropertiesMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
            final Map<String, String> _transformedProperties = ((Map<String, String>) evaluateAndTransform(getMuleContext(), event,
                    UpdateObjectPropertiesMessageProcessor.class.getDeclaredField("_propertiesType").getGenericType(), null, properties));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).updateObjectProperties(_transformedCmisObject, _transformedObjectId,
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("updateObjectProperties"), event, e);
        }
    }
