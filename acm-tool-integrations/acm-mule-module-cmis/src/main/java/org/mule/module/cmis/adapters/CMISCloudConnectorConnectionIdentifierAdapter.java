...
/**
 * A <code>CMISCloudConnectorConnectionIdentifierAdapter</code> is a wrapper around {@link CMISCloudConnector } that
 * implements {@link org.mule.devkit.dynamic.api.helper.Connection} interface.
 * 
 */
