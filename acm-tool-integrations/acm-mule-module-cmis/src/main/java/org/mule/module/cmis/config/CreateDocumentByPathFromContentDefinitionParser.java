...
import org.mule.module.cmis.config.AbstractDefinitionParser.ParseDelegate;
    ...
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateDocumentByPathFromContentMessageProcessor.class.getName());
