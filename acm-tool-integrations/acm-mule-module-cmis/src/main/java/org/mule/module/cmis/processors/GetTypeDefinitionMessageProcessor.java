...
/**
 * GetTypeDefinitionMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getTypeDefinition(java.lang.String)} method in
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedTypeId = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetTypeDefinitionMessageProcessor.class.getDeclaredField("_typeIdType").getGenericType(), null, typeId));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getTypeDefinition"), event, e);
        }
    }
