...
/**
 * ApplyAspectMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#applyAspect(java.lang.String, java.lang.String, java.util.Map)} method
 * in {@link CMISCloudConnector }. For each argument there is a field in this processor to match it. Before invoking the
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    ApplyAspectMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
            final String _transformedAspectName = ((String) evaluateAndTransform(getMuleContext(), event,
                    ApplyAspectMessageProcessor.class.getDeclaredField("_aspectNameType").getGenericType(), null, aspectName));
            final Map<String, String> _transformedProperties = ((Map<String, String>) evaluateAndTransform(getMuleContext(), event,
                    ApplyAspectMessageProcessor.class.getDeclaredField("_propertiesType").getGenericType(), null, properties));
    ...
    {
        return new DefaultResult<MetaData>(new DefaultMetaData(
                new DefaultParameterizedMapMetaDataModel(getPojoOrSimpleModel(String.class), getPojoOrSimpleModel(String.class))));
    }
