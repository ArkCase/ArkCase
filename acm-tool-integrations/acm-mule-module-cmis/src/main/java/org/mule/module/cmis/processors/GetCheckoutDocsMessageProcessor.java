...
/**
 * GetCheckoutDocsMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getCheckoutDocs(java.lang.String, java.lang.String)} method in
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedFilter = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetCheckoutDocsMessageProcessor.class.getDeclaredField("_filterType").getGenericType(), null, filter));
            final String _transformedOrderBy = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetCheckoutDocsMessageProcessor.class.getDeclaredField("_orderByType").getGenericType(), null, orderBy));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getCheckoutDocs"), event, e);
        }
    }
