...
/**
 * GetContentStreamMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getContentStream(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedCmisObject = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    GetContentStreamMessageProcessor.class.getDeclaredField("_cmisObjectType").getGenericType(), null, cmisObject));
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetContentStreamMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getContentStream"), event, e);
        }
    }
