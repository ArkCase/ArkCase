...
/**
 * CreateDocumentByPathFromContentMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#createDocumentByPathFromContent(java.lang.String, java.lang.String, java.lang.Object, java.lang.String, org.mule.module.cmis.VersioningState, java.lang.String, java.util.Map, boolean)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedFolderPath = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_folderPathType").getGenericType(), null,
                    folderPath));
            final String _transformedFilename = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_filenameType").getGenericType(), null,
                    filename));
            final Object _transformedContent = ((Object) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_contentType").getGenericType(), null,
                    content));
            final String _transformedMimeType = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_mimeTypeType").getGenericType(), null,
                    mimeType));
            final VersioningState _transformedVersioningState = ((VersioningState) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_versioningStateType").getGenericType(), null,
                    versioningState));
            final String _transformedObjectType = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_objectTypeType").getGenericType(), null,
                    objectType));
            final Map<String, String> _transformedProperties = ((Map<String, String>) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_propertiesType").getGenericType(), null,
                    properties));
            final Boolean _transformedForce = ((Boolean) evaluateAndTransform(getMuleContext(), event,
                    CreateDocumentByPathFromContentMessageProcessor.class.getDeclaredField("_forceType").getGenericType(), null, force));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).createDocumentByPathFromContent(_transformedFolderPath, _transformedFilename,
