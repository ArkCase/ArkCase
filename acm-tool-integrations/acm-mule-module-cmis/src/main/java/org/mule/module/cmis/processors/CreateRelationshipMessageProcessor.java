...
/**
 * CreateRelationshipMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#createRelationship(java.lang.String, java.lang.String, java.lang.String)}
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedParentObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateRelationshipMessageProcessor.class.getDeclaredField("_parentObjectIdType").getGenericType(), null,
                    parentObjectId));
            final String _transformedChildObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateRelationshipMessageProcessor.class.getDeclaredField("_childObjectIdType").getGenericType(), null, childObjectId));
            final String _transformedRelationshipType = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateRelationshipMessageProcessor.class.getDeclaredField("_relationshipTypeType").getGenericType(), null,
                    relationshipType));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).createRelationship(_transformedParentObjectId, _transformedChildObjectId,
                            _transformedRelationshipType);
                }
