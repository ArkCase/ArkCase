...
/**
 * ApplyAclMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#applyAcl(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.util.List, java.util.List, org.apache.chemistry.opencmis.commons.enums.AclPropagation)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedCmisObject = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    ApplyAclMessageProcessor.class.getDeclaredField("_cmisObjectType").getGenericType(), null, cmisObject));
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    ApplyAclMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
            final List<Ace> _transformedAddAces = ((List<Ace>) evaluateAndTransform(getMuleContext(), event,
                    ApplyAclMessageProcessor.class.getDeclaredField("_addAcesType").getGenericType(), null, addAces));
            final List<Ace> _transformedRemoveAces = ((List<Ace>) evaluateAndTransform(getMuleContext(), event,
                    ApplyAclMessageProcessor.class.getDeclaredField("_removeAcesType").getGenericType(), null, removeAces));
            final AclPropagation _transformedAclPropagation = ((AclPropagation) evaluateAndTransform(getMuleContext(), event,
                    ApplyAclMessageProcessor.class.getDeclaredField("_aclPropagationType").getGenericType(), null, aclPropagation));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).applyAcl(_transformedCmisObject, _transformedObjectId, _transformedAddAces,
                            _transformedRemoveAces, _transformedAclPropagation);
                }
