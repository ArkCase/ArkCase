...
/**
 * GetAllVersionsMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getAllVersions(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.lang.String, java.lang.String)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedDocument = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    GetAllVersionsMessageProcessor.class.getDeclaredField("_documentType").getGenericType(), null, document));
            final String _transformedDocumentId = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetAllVersionsMessageProcessor.class.getDeclaredField("_documentIdType").getGenericType(), null, documentId));
            final String _transformedFilter = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetAllVersionsMessageProcessor.class.getDeclaredField("_filterType").getGenericType(), null, filter));
            final String _transformedOrderBy = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetAllVersionsMessageProcessor.class.getDeclaredField("_orderByType").getGenericType(), null, orderBy));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).getAllVersions(_transformedDocument, _transformedDocumentId, _transformedFilter,
                            _transformedOrderBy);
                }
