...
/**
 * A <code>CMISCloudConnectorProcessAdapter</code> is a wrapper around {@link CMISCloudConnector } that enables custom
        ...
        implements ProcessAdapter<CMISCloudConnectorCapabilitiesAdapter>
{
    ...
    public <P> ProcessTemplate<P, CMISCloudConnectorCapabilitiesAdapter> getProcessTemplate()
    {
        ...
        return new ProcessTemplate<P, CMISCloudConnectorCapabilitiesAdapter>()
        {
            ...
            @Override
            public P execute(ProcessCallback<P, CMISCloudConnectorCapabilitiesAdapter> processCallback, MessageProcessor messageProcessor,
                    MuleEvent event)
                    throws Exception
            {
