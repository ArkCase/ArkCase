...
/**
 * CheckInMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#checkIn(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.lang.Object, java.lang.String, java.lang.String, boolean, java.lang.String, java.util.Map)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedDocument = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_documentType").getGenericType(), null, document));
            final String _transformedDocumentId = ((String) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_documentIdType").getGenericType(), null, documentId));
            final Object _transformedContent = ((Object) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_contentType").getGenericType(), null, content));
            final String _transformedFilename = ((String) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_filenameType").getGenericType(), null, filename));
            final String _transformedMimeType = ((String) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_mimeTypeType").getGenericType(), null, mimeType));
            final Boolean _transformedMajor = ((Boolean) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_majorType").getGenericType(), null, major));
            final String _transformedCheckinComment = ((String) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_checkinCommentType").getGenericType(), null, checkinComment));
            final Map<String, String> _transformedProperties = ((Map<String, String>) evaluateAndTransform(getMuleContext(), event,
                    CheckInMessageProcessor.class.getDeclaredField("_propertiesType").getGenericType(), null, properties));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).checkIn(_transformedDocument, _transformedDocumentId, _transformedContent,
                            _transformedFilename, _transformedMimeType, _transformedMajor, _transformedCheckinComment,
