...
/**
 * ApplyPolicyMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#applyPolicy(org.apache.chemistry.opencmis.client.api.CmisObject, java.lang.String, java.util.List)}
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final CmisObject _transformedCmisObject = ((CmisObject) evaluateAndTransform(getMuleContext(), event,
                    ApplyPolicyMessageProcessor.class.getDeclaredField("_cmisObjectType").getGenericType(), null, cmisObject));
            final String _transformedObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    ApplyPolicyMessageProcessor.class.getDeclaredField("_objectIdType").getGenericType(), null, objectId));
            final List<ObjectId> _transformedPolicyIds = ((List<ObjectId>) evaluateAndTransform(getMuleContext(), event,
                    ApplyPolicyMessageProcessor.class.getDeclaredField("_policyIdsType").getGenericType(), null, policyIds));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("applyPolicy"), event, e);
        }
    }
