 ...
 * @author MuleSoft, Inc.
 */
@Connector(name = "cmis", schemaVersion = "1.1", friendlyName = "CMIS", minMuleVersion = "3.4", metaData = MetaDataSwitch.ON, connectivityTesting = ConnectivityTesting.ON)
public class CMISCloudConnector implements CMISFacade
{
     ...
     * @param endpoint
     *            The type of endpoint. Values: SOAP or ATOMPUB
     * @param connectionTimeout
     *            The connection time-out specification
     * @param useAlfrescoExtension
            ...
            throws ConnectionException
    {
        ...
        synchronized (threadSafeLock)
        {
            ...
            if (facade == null)
            {
                ...
                this.facade = CMISFacadeAdaptor.adapt(
    ...
    /**
     * Returns information about the CMIS repository, the optional capabilities it supports and its Access Control
     ...
     *            An enumeration specifying what the versioning state of the newly-created object MUST be. If the
     *            repository does not support versioning, the repository MUST ignore the versioningState parameter.
     *            Valid values are:
     ...
     * @param force
     *            if should folder structure must be created when there
     ...
     * @param orderBy
     *            comma-separated list of query names and the ascending modifier
     ...
     * @param depth
     *            if "get" value is DESCENDANTS, represents the depth of the
     *            descendants tree
     * @param filter
     *            comma-separated list of properties to filter (only for CHILDREN or DESCENDANTS navigation)
     * @param orderBy
     *            comma-separated list of query names and the ascending modifier
     *            "ASC" or the descending modifier "DESC" for each query name (only for CHILDREN or DESCENDANTS
     *            navigation)
     ...
     * @param unfile
     *            Specifies how the repository must process file-able child-
