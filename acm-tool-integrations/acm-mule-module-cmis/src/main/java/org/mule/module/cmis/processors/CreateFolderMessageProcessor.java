...
/**
 * CreateFolderMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#createFolder(java.lang.String, java.lang.String)} method in
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedFolderName = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateFolderMessageProcessor.class.getDeclaredField("_folderNameType").getGenericType(), null, folderName));
            final String _transformedParentObjectId = ((String) evaluateAndTransform(getMuleContext(), event,
                    CreateFolderMessageProcessor.class.getDeclaredField("_parentObjectIdType").getGenericType(), null, parentObjectId));
