...
/**
 * GetOrCreateFolderByPathMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#getOrCreateFolderByPath(java.lang.String)} method in
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final String _transformedFolderPath = ((String) evaluateAndTransform(getMuleContext(), event,
                    GetOrCreateFolderByPathMessageProcessor.class.getDeclaredField("_folderPathType").getGenericType(), null, folderPath));
        ...
        {
            throw new MessagingException(CoreMessages.failedToInvoke("getOrCreateFolderByPath"), event, e);
        }
    }
