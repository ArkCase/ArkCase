...
/**
 * FolderMessageProcessor invokes the
 * {@link org.mule.module.cmis.CMISCloudConnector#folder(org.apache.chemistry.opencmis.client.api.Folder, java.lang.String, org.mule.module.cmis.NavigationOptions, java.lang.Integer, java.lang.String, java.lang.String)}
        ...
        implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
            ...
            throws MuleException
    {
        ...
        try
        {
            ...
            final Folder _transformedFolder = ((Folder) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_folderType").getGenericType(), null, folder));
            final String _transformedFolderId = ((String) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_folderIdType").getGenericType(), null, folderId));
            final NavigationOptions _transformedGet = ((NavigationOptions) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_getType").getGenericType(), null, get));
            final Integer _transformedDepth = ((Integer) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_depthType").getGenericType(), null, depth));
            final String _transformedFilter = ((String) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_filterType").getGenericType(), null, filter));
            final String _transformedOrderBy = ((String) evaluateAndTransform(getMuleContext(), event,
                    FolderMessageProcessor.class.getDeclaredField("_orderByType").getGenericType(), null, orderBy));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object, Object>()
            {
                ...
                public Object process(Object object)
                        throws Exception
                {
                    return ((CMISCloudConnector) object).folder(_transformedFolder, _transformedFolderId, _transformedGet,
                            _transformedDepth, _transformedFilter, _transformedOrderBy);
                }
