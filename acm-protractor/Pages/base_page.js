...
var taskTitle = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(7)
var createdTaskTitle = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(7)
var taskAssighnee = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(8);
var taskCreated = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(9);
var taskPriority = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(10);
var taskDueDate = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(11);
var taskStatus = element.all(by.repeater(Objects.casepage.locators.taskTableRows)).get(12);
