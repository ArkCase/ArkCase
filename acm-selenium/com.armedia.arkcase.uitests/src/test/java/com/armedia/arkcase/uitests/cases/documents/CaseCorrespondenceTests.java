...
public class CaseCorrespondenceTests extends ArkCaseTestBase {
	...
	public void createNewCaseAddCorrespondenceDeclareASRecord() throws InterruptedException, IOException {
		...
		Thread.sleep(6000);
		documentsPage.verifyFirstDocument("General Release.docx", "General Release", "Samuel Supervisor", "1.0",
				"RECORD");
		Thread.sleep(3000);
		documentsPage.chnageCaseStatusButton.click();
		Thread.sleep(10000);
	...
	public void createNewCaseAddCorrespondenceEditWithWord() throws InterruptedException, IOException, AWTException {
		...
		documentsPage.refreshTableButton.click();
		Thread.sleep(6000);
		documentsPage.verifyModifiedDocument("General Release.docx", "General Release", "Samuel Supervisor", "2.0",
				"ACTIVE");
	...
	@Test
	public void createNewCaseAddCorrespondenceCancelEditWithWord()
	...
	@Test
	public void createNewCaseAddCorrespondenceRenameTheCorrespondence()
			throws InterruptedException, IOException, AWTException {
	...
	@Test
	public void createNewCaseAddCorrespondenceCheckoutCancelEditing()
			throws InterruptedException, IOException, AWTException {
