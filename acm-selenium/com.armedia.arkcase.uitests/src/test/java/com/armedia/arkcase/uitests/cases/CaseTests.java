...
public class CaseTests extends ArkCaseTestBase {
	...
	public void createNewCaseAddEditDeleteDetailsLink() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		casesPom.insertedLinkClick();
		casesPom.unlinkClick();
		casesPom.detailsTextClear();
		casesPom.detailsSaveButtonClick();
		Assert.assertTrue(casesPom.caseDetailsSavedPopup.getText().equals("Case details saved"));
		Thread.sleep(2000);
...
//		wait1.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@role='combobox']")));	
		...
		WebDriverWait waitNext= new WebDriverWait(driver, 30);
		...
		casesPom.clickFirstCaseExpander();
		casesPom.clickFirstCaseDetailsLink();
		casesPom.verifyDetailsSection();
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		casesPom.detailsChangeStatusButtonClick();
		Thread.sleep(10000);
		driver.switchTo().frame(casesPom.chnageCaseStausFrameOne);
		Thread.sleep(2000);
		driver.switchTo().frame(casesPom.chnageCaseStatusFrameTwo);
