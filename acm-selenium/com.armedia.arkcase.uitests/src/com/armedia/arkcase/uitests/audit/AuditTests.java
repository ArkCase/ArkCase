...
public class AuditTests extends ArkCaseTestBase {
	...
	public void generateAuditReportforALL() throws Exception {
		...
		casePom.generateAuditReport(Utility.getCellData(1, 1), Utility.getCellData(1, 2), Utility.getCellData(1, 3),
	...
	public void generateAuditReportforCaseFiles() throws Exception {
		...
		Utility.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "Sheet2");
		casePom.ReportsMenuClick();
		casePom.generateAuditReport(Utility.getCellData(2, 1), Utility.getCellData(2, 2), Utility.getCellData(2, 3),
	...
	public void generateAuditReportforComplaints() throws Exception {
		...
		Utility.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "Sheet2");
		casePom.ReportsMenuClick();
		casePom.generateAuditReport(Utility.getCellData(3, 1), Utility.getCellData(3, 2), Utility.getCellData(3, 3),
	...
	public void generateAuditReportforTasks() throws Exception {
		...
		Utility.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "Sheet2");
		casePom.ReportsMenuClick();
		casePom.generateAuditReport(Utility.getCellData(4, 1), Utility.getCellData(4, 2), Utility.getCellData(4, 3),
	...
	public void generateAuditReportforFiles() throws Exception {
		...
		Utility.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "Sheet2");
		casePom.ReportsMenuClick();
		casePom.generateAuditReport(Utility.getCellData(5, 1), Utility.getCellData(5, 2), Utility.getCellData(5, 3),
