...
public class ReportsTests extends ArkCaseTestBase {
	...
	public void generateCaseReportforDrafts() throws Exception {
		...
		casePom.generateReport(Utility.getCellData(1, 1), Utility.getCellData(1, 2),Utility.getCellData(1, 3),Utility.getCellData(1, 4));	
	...
	public void generateCaseReportforInApproval() throws Exception {
		...
		super.logIn();
		casePom.ReportsMenuClick();
		casePom.generateReport(Utility.getCellData(2, 1), Utility.getCellData(2, 2),Utility.getCellData(2, 3),Utility.getCellData(2, 4));	
		driver.switchTo().frame("reports-iframe");		
		driver.switchTo().defaultContent();
		ArkCaseAuthentication.logOut(driver);
	...
	public void generateCaseReportforActive() throws Exception {
		...
		super.logIn();
		casePom.ReportsMenuClick();
		casePom.generateReport(Utility.getCellData(3, 1), Utility.getCellData(3, 2),Utility.getCellData(3, 3),Utility.getCellData(3, 4));
		driver.switchTo().frame("reports-iframe");		
		driver.switchTo().defaultContent();
		ArkCaseAuthentication.logOut(driver);
	...
	public void generateCaseReportforInactive() throws Exception {
		...
		super.logIn();
		casePom.ReportsMenuClick();
		casePom.generateReport(Utility.getCellData(4, 1), Utility.getCellData(4, 2),Utility.getCellData(4, 3),Utility.getCellData(4, 4));	
		driver.switchTo().frame("reports-iframe");		
		driver.switchTo().defaultContent();
		ArkCaseAuthentication.logOut(driver);
	...
	public void generateCaseReportforClosed() throws Exception {
		...
		super.logIn();
		casePom.ReportsMenuClick();		
		casePom.generateReport(Utility.getCellData(5, 1), Utility.getCellData(5, 2),Utility.getCellData(5, 3),Utility.getCellData(5, 4));
		driver.switchTo().frame("reports-iframe");		
		driver.switchTo().defaultContent();
		ArkCaseAuthentication.logOut(driver);
