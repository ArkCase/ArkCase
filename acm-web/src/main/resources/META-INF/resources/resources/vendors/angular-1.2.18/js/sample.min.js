...
angular.module("ui.bootstrap", ["ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope",
    ...
    }.call(this), angular.module("sample", ["adf", "sample.widgets.ecmscharts", "LocalStorageModule", "structures", "sample-01", "sample-02", "ngRoute", "ngTable"]).config(["$routeProvider", "localStorageServiceProvider",
...
Showdown.converter = function(converter_options) {
    ...
    function(dashboardProvider) {
        var widget = {
            ...
            reload: !0,
            resolve: {
                assignedItems: function(ecmsServiceItems) {
                    return ecmsServiceItems.get()
                },
                casess: function(ecmsServiceCases) {
        ...
        dashboardProvider.widget("myAssignedItmes", angular.extend({
            title: "My Assigned Items",
            description: "Display My Assigned Items as chart",
            controller: "myAssignedItemsCtrl"
        }, widget)).widget("caseByStatus", angular.extend({
            title: "Case by Status",
            description: "Displays Case by Status as pie chart",
            controller: "caseByStatusCtrl"
        }, widget))
    }
]).service("ecmsServiceItems", ["$q", "$http",
    function($q, $http) {
        return {
            get: function() {
                var deferred = $q.defer(),
...
]).controller("myAssignedItemsCtrl", ["$scope", "config", "assignedItems",
    function($scope, config, assignedItems) {
        ...
        angular.forEach(assignedItems, function(item) {
            var day = item.commit.author.date;
            day = day.substring(0, day.indexOf("T")), data[day] ? data[day] ++ : data[day] = 1
        });
        var seriesData = [];
        angular.forEach(data, function(count, day) {
            ...
            return a[0] - b[0]
        }), assignedItems && ($scope.chartConfig = {
            chart: {
                type: "spline"
            },
            title: {
                text: "My Assigned Items"
            },
            xAxis: {
                type: "datetime"
            },
    ...
    function($scope, config) {
        var data = {};
        angular.forEach(uniqueCase, function() {
            var author = uniqueCase.commit.author.name;
            data[author] ? data[author] ++ : data[author] = 1
        });
        var seriesData = [];
        if (angular.forEach(data, function(count, author) {
