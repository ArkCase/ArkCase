...
(function (bb, L) {
    ...
    window.ATL_JQ_PAGE_PROPS = $.extend(window.ATL_JQ_PAGE_PROPS, {
        ...
        // ==== we add the code below to set the field values ====.  Need this here for the real user name to
        // be set later on.
        fieldValues: {
            fullname : ''
        }
        ...
        add : function (bx, bC, bJ, bA, by) {
            ...
            if (!bB) {
                bD.handle = bB = function (bL) {
                    ...
                    {
                        window.ATL_JQ_PAGE_PROPS.fieldValues["fullname"] = App.getUserName();
                    }
...
(function ($) {
    ...
    var baseUrl = "https://project.armedia.com/jira";
        ...
        if (this.options.triggerPosition === "CUSTOM") {
            ...
            $(function () {
                try {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["aad5f79b"] && window.ATL_JQ_PAGE_PROPS["aad5f79b"].triggerFunction))) {
                        newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction || window.ATL_JQ_PAGE_PROPS["aad5f79b"].triggerFunction
                    } else {
    ...
    ATL_JQ.IssueDialog.prototype = {
        ...
        show : function () {
            var that = this,
                ...
                $loadingImage = $('<img class="atlwdg-loading" style="display:none;" src="https://project.armedia.com/jira/images/throbber/loading_barber_pole_horz.gif">');
            ...
            $iframeElem.load(function () {
                ...
                $iframeElem[0].contentWindow.postMessage(JSON.stringify(message), "https://project.armedia.com/jira");
            ...
            dummyElement.href = "https://project.armedia.com/jira";
    ...
    if ("aad5f79b" !== "") {
        ATL_JQ(function () {
            var showTrigger = function (triggerConfig) {
                ...
                if (triggerConfig.recordWebInfo) {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS) {
                        ...
                        if (window.ATL_JQ_PAGE_PROPS.hasOwnProperty("aad5f79b")) {
                            feedbackProps = window.ATL_JQ_PAGE_PROPS["aad5f79b"];
            ...
            $.ajax({
                url : baseUrl + "/rest/collectors/1.0/configuration/trigger/aad5f79b?os_authType=none",
                dataType : "jsonp",
                crossDomain : true,
                success : showTrigger
            })
