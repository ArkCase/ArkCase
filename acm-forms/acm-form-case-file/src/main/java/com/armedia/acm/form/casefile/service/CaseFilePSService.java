...
public class CaseFilePSService extends FrevvoFormAbstractService {
	...
	private CaseFilePSForm saveCaseFile(CaseFilePSForm form) throws AcmCreateObjectFailedException 
	{
	...
	public void updateXML(CaseFile caseFile, Authentication auth)
    {
    	if (caseFile != null)
    	{    		
    		CaseFilePSForm form = getCaseFilePSFactory().asFrevvoCaseFile(caseFile, null);
