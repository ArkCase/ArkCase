 ...
 */
public abstract class AcmAssigneeChangeChecker
{
    ...
    public void onApplicationEvent(AcmObjectHistoryEvent event)
    {
        if (event != null)
        {
            ...
            if (!isSupportedObjectType(acmObjectHistory.getObjectType()))
            {
                return;
            }
    ...
    public abstract boolean isSupportedObjectType(String objectType);
