 ...
 */
public class FacetComplaintDto implements IFacetDto{
    ...
    private List<String> complaintStatusList;
    ...
    public List<String> getIncidentTypeList() {
        return incidentTypeList;
    }

    public void setIncidentTypeList(List<String> incidentTypeList) {
