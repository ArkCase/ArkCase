...
public class FolderParticipantsChangedEventListener implements ApplicationListener<EcmFolderParticipantChangedEvent>
{
    ...
    @Override
    public void onApplicationEvent(EcmFolderParticipantChangedEvent event)
    {
        ...
        changedParticipants.setCmisObjectId(folder.getCmisFolderId());
