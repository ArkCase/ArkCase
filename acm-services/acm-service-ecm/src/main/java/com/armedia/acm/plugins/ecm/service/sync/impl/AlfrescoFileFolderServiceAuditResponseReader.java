...
/**
 * Read Alfresco audit records generated by the Alfresco FileFolderService.  Alfresco uses the NodeService to create
 * content files (but NOT to create folders, or thumbnails... Alfresco uses the NodeService to create folders and
 * thumbnails).
 * <p>
 * For now, from the file/folder we are interested only in new content files.  This reader ignores all other new
 * content types.
 */
public class AlfrescoFileFolderServiceAuditResponseReader implements CreateNodesResponseReader
{
