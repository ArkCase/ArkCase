...
public class EcmFileCamelUtils
{
    ...
    public void deleteFile(EcmFile ecmFile, String cmisFileId) throws Exception
    {
        ...
        // Invokes the camel flow to delete the file contents from the repository
        log.debug("rolling back file download for cmis id: " + cmisFileId + " using " + ArkCaseCMISActions.DELETE_DOCUMENT.getQueueName());
