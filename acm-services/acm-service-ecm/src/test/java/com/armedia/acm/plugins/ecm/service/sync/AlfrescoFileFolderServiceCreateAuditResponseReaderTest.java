...
public class AlfrescoFileFolderServiceCreateAuditResponseReaderTest
{
    ...
    public void readResponse() throws Exception
    {
        ...
        Object[][] expectedData = {
                ...
                {EcmEventType.CREATE, 55L, "admin", "folder", "workspace://SpacesStore/4d1b5ed8-7544-4cf6-acc0-384756138f95", "document", "workspace://SpacesStore/0af7fe58-885d-4f01-a9e6-0ebf994abb3f", "ArkCase - Infrastructure Team - Scrum - 2017-05-05.docx"},
