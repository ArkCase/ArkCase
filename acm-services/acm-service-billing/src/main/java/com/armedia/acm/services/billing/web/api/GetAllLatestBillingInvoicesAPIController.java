...
public class GetAllLatestBillingInvoicesAPIController
{

    BillingService billingService;

    @RequestMapping(value = "/invoices/all", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public List<BillingInvoice> getBillingInvoicesByObjectTypeAndId(
            Authentication authentication, HttpSession httpSession)
            throws GetBillingInvoiceException
    {
        return getBillingService().getAllLatestBillingInvoices();
    }
