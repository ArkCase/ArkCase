...
public class TranscribeQueueJobTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        transcribeQueueJob.setMediaEngineIntegrationService(mediaEngineIntegrationService);
    ...
    public void executeTask() throws Exception
    {
        ...
        when(transcribeQueueJob.getObjectLockService().findLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE)).thenReturn(lock);
        when(transcribeQueueJob.getMediaEngineMapper().MediaEngineToDTO(any())).thenReturn(new MediaEngineDTO());
        when(transcribeQueueJob.getObjectLockingManager().acquireObjectLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE,
        ...
        verify(transcribeConfigurationPropertiesService, times(2)).get();
        ...
        verify(objectLockService).findLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE);
        verify(objectLockingManager).acquireObjectLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE,
                MediaEngineConstants.LOCK_TYPE_WRITE, null, true, TranscribeConstants.TRANSCRIBE_SYSTEM_USER);
        verify(mediaEngineIntegrationService).create(any());
