...
public class TranscribeQueueJobDescriptor extends AcmJobDescriptor
{
    ...
    public TranscribeQueueJob getTranscribeQueueJob()
    {
        return transcribeQueueJob;
    }

    public void setTranscribeQueueJob(TranscribeQueueJob transcribeQueueJob)
    {
        this.transcribeQueueJob = transcribeQueueJob;
    }
}
