...
@AttributeOverrides({
        ...
        @AttributeOverride(name = "mediaEcmFileVersion", column = @Column(name = "cm_transcribe_media_file_version_id")),
...
@AssociationOverride(name = "mediaEcmFileVersion", joinColumns = @JoinColumn(name = "cm_transcribe_media_file_version_id"))
