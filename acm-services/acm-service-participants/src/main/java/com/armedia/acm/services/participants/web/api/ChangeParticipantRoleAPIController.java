...
public class ChangeParticipantRoleAPIController
{
            ...
            Authentication authentication) throws AcmUserActionFailedException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new AcmUserActionFailedException(ParticipantConstants.USER_ACTION_UPDATE, ParticipantConstants.OBJECT_TYPE, participantId,
                    "Updating the Role on the Participant failed!", e);
        }
