...
public class SolrReindexCaseFileExecutor implements AcmDataUpdateExecutor {
    ...
    {
        return "solr_caseFile_reindex_v2";
    }

    @Override
    public void execute()
    {
        solrReindexService.reindex(Arrays.asList(CaseFile.class));
    }
