...
public class OCRQueueJobTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        ocrQueueJob.setMediaEngineIntegrationService(mediaEngineIntegrationService);
    ...
    public void executeTask() throws Exception
    {
        ...
        when(ocrQueueJob.getObjectLockService().findLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE)).thenReturn(lock);
        when(ocrQueueJob.getMediaEngineMapper().MediaEngineToDTO(any())).thenReturn(new MediaEngineDTO());
        when(ocrQueueJob.getObjectLockingManager().acquireObjectLock(105l, MediaEngineConstants.OBJECT_TYPE_FILE,
        ...
        verify(ocrConfigurationPropertiesService, times(2)).get();
