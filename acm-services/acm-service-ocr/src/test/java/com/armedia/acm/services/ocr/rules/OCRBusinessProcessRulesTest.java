package com.armedia.acm.services.ocr.rules;
 ...
 */
public class OCRBusinessProcessRulesTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        Resource xls = new ClassPathResource("/rules/drools-ocr-business-process-rules.xlsx");
