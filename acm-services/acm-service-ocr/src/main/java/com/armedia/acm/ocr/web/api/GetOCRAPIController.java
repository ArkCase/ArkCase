package com.armedia.acm.ocr.web.api;
...
public class GetOCRAPIController
{
    ...
    @ResponseBody
    public OCR getOcr(@PathVariable(value = "id") Long id) throws GetOCRException
    {
    ...
    @ResponseBody
    public OCR getOcrByMediaId(@PathVariable(value = "mediaVersionId") Long mediaVersionId) throws GetOCRException
    {
    ...
    @ResponseBody
    public OCR getOcrByFileId(@PathVariable(value = "fileId") Long fileId) throws GetOCRException
    {
