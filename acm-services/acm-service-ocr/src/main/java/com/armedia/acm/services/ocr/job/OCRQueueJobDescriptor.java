...
public class OCRQueueJobDescriptor extends AcmJobDescriptor
{
    ...
    public OCRQueueJob getOcrQueueJob()
    {
        return ocrQueueJob;
    }

    public void setOcrQueueJob(OCRQueueJob ocrQueueJob)
    {
        this.ocrQueueJob = ocrQueueJob;
    }
}
