 ...
 * iTextG
 * %%
 * Copyright (C) 1998 - 2019 ArkCase LLC
 * %%
...
//    protected ArrayList chunks = new ArrayList();
    ...
    // ---------- ArkCase modification START ----------
    public void addElement(Element element) {
        if (element == null || element.type() == Element.WRITABLE_DIRECT) {
            return;
        }
    // ---------- ArkCase modification END ----------    
        ...
        // ---------- ArkCase modification START ----------
        if (element.type() == Element.WRITABLE_DIRECT) {
            return;
        }
        // ---------- ArkCase modification END ----------
