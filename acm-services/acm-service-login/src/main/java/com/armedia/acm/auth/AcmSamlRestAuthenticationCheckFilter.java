...
/**
 * Filter that clears the {@link Authentication} object from the {@link SecurityContext} and returns 401 Unauthorized error. Only used in
 * the Single Sign-On scenario. This filter is used for REST calls and does not cause a redirect to /samllogin page, but lets
