...
public class NotificationServiceTest extends EasyMockSupport
{
    ...
    public void testRunEmailSent() throws AcmEncryptionException
    {
        ...
        expect(mockPropertyFileManager.load(capture(stringCapture), eq("email.sender.type"), capture(stringCapture))).andReturn("smtp")
                .anyTimes();
        expect(mockPropertyFileManager.load(capture(stringCapture), eq("email.sender.encryption"), capture(stringCapture)))
...
/*
    @Test
    public void testRunEmailSentStartTLS() throws AcmEncryptionException
    {
        List<Notification> notifications = new ArrayList<>();
    ...
    @Test
    public void testRunEmailNotSentStartTLS() throws AcmEncryptionException
    {
        List<Notification> notifications = new ArrayList<>();
