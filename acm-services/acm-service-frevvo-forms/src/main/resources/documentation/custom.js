...
var CustomEventHandlers = {
    ...
    showOrganizationPicker: function(event, element, formType) {
        if (!isEmpty(frevvoMessaging)) {
            ...
            message.source = "frevvo";
            message.data = "";
            message.action = "open-organization-picker";
            message.elementId = element.id;
            message.formType = formType;
...
function isCaseOrganizationPicker(element) {
    var cssClass = getCssClass(element);
    return (cssClass && cssClass.indexOf('caseOrganizationPicker') > -1);
}

function isComplaintOrganizationPicker(element) {
    var cssClass = getCssClass(element);
