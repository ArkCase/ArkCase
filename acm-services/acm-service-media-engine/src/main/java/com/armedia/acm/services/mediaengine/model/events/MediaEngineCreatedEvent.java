 ...
 */
public class MediaEngineCreatedEvent extends MediaEngineEvent
{
    public MediaEngineCreatedEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.CREATED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
