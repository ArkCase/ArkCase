 ...
 */
public class MediaEngineQueuedEvent extends MediaEngineEvent
{
    public MediaEngineQueuedEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.QUEUED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
