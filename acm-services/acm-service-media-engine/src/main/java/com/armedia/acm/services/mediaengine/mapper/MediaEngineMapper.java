...
public class MediaEngineMapper
{
    ...
    public MediaEngineDTO MediaEngineToDTO(MediaEngine mediaEngine)
    {
        ...
        try
        {
            ...
            mediaEngineDTO.setMediaEcmFileVersion(mediaVersionInputStream);
        ...
        catch (MuleException | IllegalAccessException | InvocationTargetException e)
        {
