 ...
 */
public class MediaEngineRollbackEvent extends MediaEngineEvent
{

    public MediaEngineRollbackEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.ROLLBACK_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
