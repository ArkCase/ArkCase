 ...
 */
public class MediaEngineProviderFailedEvent extends MediaEngineEvent
{
    public MediaEngineProviderFailedEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.PROVIDER_FAILED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
