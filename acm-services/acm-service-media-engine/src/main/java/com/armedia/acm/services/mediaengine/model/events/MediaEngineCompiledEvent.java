 ...
 */
public class MediaEngineCompiledEvent extends MediaEngineEvent
{
    public MediaEngineCompiledEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.COMPILED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
