 ...
 */
public class MediaEngineFailedEvent extends MediaEngineEvent
{
    public MediaEngineFailedEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.FAILED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
