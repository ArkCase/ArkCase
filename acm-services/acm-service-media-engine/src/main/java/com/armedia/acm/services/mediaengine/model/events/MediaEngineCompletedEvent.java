 ...
 */
public class MediaEngineCompletedEvent extends MediaEngineEvent
{
    public MediaEngineCompletedEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.COMPLETED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
