        ...
        implements MediaEngineService<T, K>
{
    ...
    {
        if (!allow(mediaEngine.getMediaEcmFileVersion()) || mediaEngine.getId() != null)
        {
    ...
    public ProcessInstance startBusinessProcess(MediaEngine mediaEngine, String serviceName)
    {
        ...
        if (mediaEngine != null)
        {
            ...
            MediaEngineBusinessProcessModel mediaEngineBusinessProcessModel = new MediaEngineBusinessProcessModel();
