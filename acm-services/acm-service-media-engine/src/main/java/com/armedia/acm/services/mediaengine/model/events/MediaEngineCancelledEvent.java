 ...
 */
public class MediaEngineCancelledEvent extends MediaEngineEvent
{
    public MediaEngineCancelledEvent(MediaEngine source, String service)
    {
    ...
    {
        return MediaEngineConstants.CANCELLED_EVENT.replace("[SERVICE]", getServiceName().toLowerCase());
    }
}
