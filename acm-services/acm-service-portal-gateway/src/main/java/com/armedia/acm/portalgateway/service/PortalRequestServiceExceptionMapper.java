 ...
 *
 */
public class PortalRequestServiceExceptionMapper implements PortalServiceExceptionMapper
{
    private transient final Logger log = LogManager.getLogger(getClass());

    private PortalRequestServiceException exception;

    /**
     * @param se
     */
    public PortalRequestServiceExceptionMapper(PortalRequestServiceException se)
    {
        exception = se;
    }
