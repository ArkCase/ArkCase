...
public class GetCostsheetsForUserAPIControllerTest extends EasyMockSupport {

	private Logger LOG = LoggerFactory.getLogger(getClass());
	
	private MockMvc mockMvc;
	private CostsheetService mockCostsheetService;
	private GetCostsheetsForUserAPIController unit;
    ...
    public void setUp() throws Exception
    {
		...
		unit = new GetCostsheetsForUserAPIController();
	...
	@Test
	public void getCostsheetsForUserSuccessTest() throws Exception
	{		
		...
		expect(mockCostsheetService.getObjectsFromSolr("COSTSHEET", mockAuthentication, 0, 10, "", "acm-user")).andReturn(expected);
		
		replayAll();
		
		MvcResult result = mockMvc.perform(
	            get("/api/v1/service/costsheet/user/{userId}", "acm-user")
	...
	@Test
	public void getCostsheetsForUserFailedTest() throws Exception
	{		
		Class<?> expectedThrowableClass = AcmListObjectsFailedException.class;
		
		expect(mockAuthentication.getName()).andReturn("acm-user");
		expect(mockCostsheetService.getObjectsFromSolr("COSTSHEET", mockAuthentication, 0, 10, "", "acm-user")).andReturn(null);
